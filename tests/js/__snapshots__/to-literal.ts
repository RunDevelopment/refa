...
module.exports[n`JS.toLiteral >> Unicode to UTF16 >> /abc/u 	({"flags":{"unicode":false}}) `] = lit`
/abc/
`;

module.exports[n`JS.toLiteral >> Unicode to UTF16 >> /abc/iu 	({"flags":{"unicode":false}}) `] = lit`
/ABC/i
`;

module.exports[n`JS.toLiteral >> Unicode to UTF16 >> /\w+/u 	({"flags":{"unicode":false}}) `] = lit`
/\w+/
`;

module.exports[n`JS.toLiteral >> Unicode to UTF16 >> /\w+/iu 	({"flags":{"unicode":false}}) `] = lit`
/[\w\u017f\u212a]+/
`;
...
module.exports[n`JS.toLiteral >> Unicode to UTF16 >> /./iu 	({"flags":{"unicode":false}}) `] = lit`
/(?:[^\n\r\u2028\u2029\ud800-\udfff]|[\ud800-\udbff][\udc00-\udfff]|[\ud800-\udbff](?![\udc00-\udfff])|(?<![\uda00-\udbff])[\udc00-\udfff])/
`;

module.exports[n`JS.toLiteral >> Unicode to UTF16 >> /./isu 	({"flags":{"unicode":false}}) `] = lit`
/(?:[^\ud800-\udfff]|[\ud800-\udbff][\udc00-\udfff]|[\ud800-\udbff](?![\udc00-\udfff])|(?<![\uda00-\udbff])[\udc00-\udfff])/
`;
...
module.exports[n`JS.toLiteral >> Unicode to UTF16 >> /\p{ASCII_Hex_Digit}/u 	({"flags":{"unicode":false}}) `] = lit`
/[\dA-F]/i
`;

module.exports[n`JS.toLiteral >> Unicode to UTF16 >> /\p{Script_Extensions=Anatolian_Hieroglyphs}/u 	({"flags":{"unicode":false}}) `] = lit`
/(?:\ud811[\udc00-\ude46])/
`;
...
module.exports[n`JS.toLiteral >> Unicode to UTF16 >> /[\p{ASCII_Hex_Digit}_]/u 	({"flags":{"unicode":false}}) `] = lit`
/[\dA-F_]/i
`;
...
module.exports[n`JS.toLiteral >> Unicode to UTF16 >> /[\p{Script_Extensions=Anatolian_Hieroglyphs}_]/u 	({"flags":{"unicode":false}}) `] = lit`
/(?:_|\ud811[\udc00-\ude46])/
`;
...
module.exports[n`JS.toLiteral >> Unicode to UTF16 >> /(?:\p{Script_Extensions=Wancho})/u 	({"flags":{"unicode":false}}) `] = lit`
/(?:(?:\ud838[\udec0-\udef9\udeff]))/
`;

module.exports[n`JS.toLiteral >> Prism regexes >> snapshot `] = lit`
/<!--[^]*?-->/
/<\?[^]+?\?>/
/<!\[CDATA\[[^]*?\]\]>/i
/<!DOCTYPE(?:[^"'>[\]]|"[^"]*"|'[^']*')+(?:\[(?:[^"'<\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\]\s*)?>/i
