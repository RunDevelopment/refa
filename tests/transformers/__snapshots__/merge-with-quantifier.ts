...
module.exports[n`Transformers >> merge-with-quantifier >> /aab(?:ab)*/ `] = lit`
/a(?:ab)+/
`;

module.exports[n`Transformers >> merge-with-quantifier >> /aba(?:ab)*/ `] = lit`
/aba(?:ab)*/
`;

module.exports[n`Transformers >> merge-with-quantifier >> /(?:ab)*aba/ `] = lit`
/(?:ab)+a/
`;

module.exports[n`Transformers >> merge-with-quantifier >> /(?:ab)*baa/ `] = lit`
/(?:ab)*baa/
`;
...
/\$?["\u201c\u201d](?:["\u201c\u201d]{2}|[^"\u201c\u201d])*["\u201c\u201d]C?/i
/#[\t\x0b\f \xa0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]*(?:\d+(?:-\d+-|\/\d+\/)\d+(?:[\t\x0b\f \xa0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]+(?:\d+[\t\x0b\f \xa0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]*(?:AM|PM)|\d+(?::\d+){1,2}(?:[\t\x0b\f \xa0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]*(?:AM|PM))?))?|\d+[\t\x0b\f \xa0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]*(?:AM|PM)|\d+(?::\d+){1,2}(?:[\t\x0b\f \xa0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]*(?:AM|PM))?)[\t\x0b\f \xa0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]*#/i
/[-!#$%&*+/<=>@\\^]/
