...
module.exports["Transformers >> apply-assertions >> /(?!a|\"\"\")./s"] = `
/(?!""")[^a]/
`.slice(1, -1);
...
module.exports["Transformers >> apply-assertions >> /(?=foo)foo/i"] = `
/FOO/i
`.slice(1, -1);

module.exports["Transformers >> apply-assertions >> /(?!foo)bar/i"] = `
/BAR/i
`.slice(1, -1);

module.exports["Transformers >> apply-assertions >> /(?!food)foo/i"] = `
/FOO(?!D)/i
`.slice(1, -1);

module.exports["Transformers >> apply-assertions >> /(?!food)foot/i"] = `
/FOOT/i
`.slice(1, -1);

module.exports["Transformers >> apply-assertions >> /(?!food)foo\\w/i"] = `
/FOO[\\dABCE-Z_]/i
`.slice(1, -1);

module.exports["Transformers >> apply-assertions >> /\\(\\s*(?!\\s)(?:[^()]|\\([^()]*\\))*?(?=\\s*\\))/"] = `
/\\(\\s*(?:(?!\\s)|(?:[^\\s()]|\\([^()]*\\))(?:[^()]|\\([^()]*\\))*?)(?=\\s*\\))/
`.slice(1, -1);
...
module.exports["Transformers >> apply-assertions >> /\"\"\"((?!\"\"\").)*\"\"\"/s"] = `
/"""(?:(?!""")[^])*"""/
`.slice(1, -1);
...
module.exports["Transformers >> apply-assertions >> /(?:^|[^.]|\\.\\.\\.\\s*)(?<!\\w)(?:as|async(?=\\s*(?:function(?!\\w)|\\(|[\\w$\\xa0-\\uffff]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|for|from|function|[gs]et(?=\\s*[\\w$[\\xa0-\\uffff])|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?!\\w)/"] = `
...
module.exports["Transformers >> apply-assertions >> /(?:\\b[a-z][a-z_\\d]*\\s*::\\s*)*\\b[a-z][a-z_\\d]*\\s*::(?!\\s*<)/"] = `
/(?:(?:(?:(?:(?:(?:(?<!\\w)[a-z][\\d_a-z]*\\s*::\\s*)+(?<!\\w)|(?<!\\w))[a-z][\\d_a-z]*\\s*::\\s*|(?<!\\w))[a-z][\\d_a-z]*\\s*::\\s*|(?<!\\w))[a-z][\\d_a-z]*\\s*::\\s*|(?<!\\w))[a-z][\\d_a-z]*\\s*::\\s*|(?<!\\w))[a-z][\\d_a-z]*\\s*::(?!\\s*<)/
`.slice(1, -1);
...
/^\\s*#!.+/
/(?:^|[^\\\\])(?:\\/\\+(?:\\/\\+(?:[^+]|\\+(?!\\/))*\\+\\/|(?!\\/\\+)[^])*?\\+\\/|\\/\\/.*|\\/\\*[^]*?\\*\\/)/
/(?<!\\w)[rx]"(?:\\\\[^]|[^"\\\\])*"[cdw]?|(?<!\\w)q"(?:\\[[^]*?\\]|\\([^]*?\\)|<[^]*?>|\\{[^]*?\\})"|(?<!\\w)q"[A-Z_a-z]\\w*(?:\$^|[\\n\\r\\u2028\\u2029](?:|[^]*?[\\n\\r\\u2028\\u2029]))[]Unknown:\\\\1[]"|(?<!\\w)q".[^]*?[]Unknown:\\\\2[]"|'(?:\\\\(?:\\W|\\w+)|[^\\\\])'|(?:"(?:\\\\[^]|[^"\\\\])*"|\`(?:\\\\[^]|[^\\\\\`])*\`)[cdw]?/m
/(?<!\\w)q\\{(?:\\{[^{}]*\\}|[^{}])*\\}/
...
/\\b(?:class|extends|implements|instanceof|interface|new|type)\\s+(?!keyof(?!\\w))[\$A-Z_a-z\\xa0-\\uffff][\\w\$\\xa0-\\uffff]*(?:\\s*<(?:[^<>]|<(?:[^<>]|<[^<>]*>)*>)*>)?/
...
/&&|\\|\\||[-\$%&*+\\\\\\xf7\\u22bb^]=?|\\/[/=]?|!=?=?|\\|[=>]?|<(?:<=?|[:=|])?|>(?:=|>>?=?)?|==?=?|['~\\u221a\\u221b\\u2260\\u2264\\u2265]/
/::?|[(),.;?[\\]{}]/
/\\b(?:(?:NaN|Inf)(?:16|32|64)?|im|pi|e|catalan|eulergamma|golden)\\b|[\\u03b3\\u03c0\\u03c6\\u212f]/
/(?:^|[^\\\\])(?:#=(?:[^#=]|=(?!#)|#(?!=)|#=(?:[^#=]|=(?!#)|#(?!=))*=#)*=#|#.*)/
/r"(?:\\\\.|[^\\n\\r"\\\\])*"[imsx]{0,4}/
/"""[^]+?"""|\\w*"(?:\\\\.|[^\\n\\r"\\\\])*"|(?:^|[^\\w'])'(?:\\\\[^\\n\\r][^\\n\\r']*|[^\\n\\r\\\\])'|\`(?:[^\\n\\r\\\\\`]|\\\\.)*\`/
/(?<!\\w)C\\s.*/i
...
/(?:[\\x21-\\x27*+,\\-./:<=>?@\\\\\`|~\\xa1-\\xbf\\xd7-\\xf7\\u20d0-\\u2bff^]|(?<!\\w)_+(?!\\w))+|\\b(?:and|div|mod|not|or)\\b/
/[(),;[\\]{|}]/
/%<[^]+?%>/
