...
/\\b\\b(?:class|enum|interface|struct)(?<=\\w)\\s+(?:@|)[A-Z_a-z]\\w*\\b(?:\\s*<(?:[^-%&*+/;<=>|^]|<(?:[^-%&*+/;<=>|^]|<(?:[^-%&*+/;<=>|^]|<[^-%&*+/;<=>|^]*>)*>)*>)*>)?/
...
/<(?:[^-%&*+/;<=>|^]|<(?:[^-%&*+/;<=>|^]|<(?:[^-%&*+/;<=>|^]|<[^-%&*+/;<=>|^]*>)*>)*>)*>/i
/(?:\\((?:[^-%&()*+,/;<=>[\\]\\^|]|<(?:[^-%&*+/;<=>|^]|<(?:[^-%&*+/;<=>|^]|<(?:[^-%&*+/;<=>|^]|<[^-%&*+/;<=>|^]*>)*>)*>)*>|\\((?:[^()]|\\((?:[^()]|\\((?:[^()]|\\([^()]*\\))*\\))*\\))*\\)|\\[\\s*(?:,\\s*)*\\])+(?:,(?:[^-%&()*+,/;<=>[\\]\\^|]|<(?:[^-%&*+/;<=>|^]|<(?:[^-%&*+/;<=>|^]|<(?:[^-%&*+/;<=>|^]|<[^-%&*+/;<=>|^]*>)*>)*>)*>|\\((?:[^()]|\\((?:[^()]|\\((?:[^()]|\\([^()]*\\))*\\))*\\))*\\)|\\[\\s*(?:,\\s*)*\\])+)+\\)|(?!\\b(?:class|enum|interface|struct|add|alias|and|ascending|async|await|by|descending|from|get|global|group|into|join|let|nameof|not|notnull|on|or|orderby|partial|remove|select|set|unmanaged|value|when|where|where|abstract|as|base|break|case|catch|checked|const|continue|default|delegate|do|else|event|explicit|extern|finally|fixed|for|foreach|goto|if|implicit|in|internal|is|lock|namespace|new|null|operator|out|override|params|private|protected|public|readonly|ref|return|sealed|sizeof|stackalloc|static|switch|this|throw|try|typeof|unchecked|unsafe|using|virtual|volatile|while|yield)(?:(?<!\\w)\\w|(?<=\\w)(?!\\w)))(?:@|(?<!\\w))[A-Z_a-z]\\w*\\b(?:\\s*<(?:[^-%&*+/;<=>|^]|<(?:[^-%&*+/;<=>|^]|<(?:[^-%&*+/;<=>|^]|<[^-%&*+/;<=>|^]*>)*>)*>)*>)?(?:\\s*\\.\\s*(?:@|(?<!\\w))[A-Z_a-z]\\w*\\b(?:\\s*<(?:[^-%&*+/;<=>|^]|<(?:[^-%&*+/;<=>|^]|<(?:[^-%&*+/;<=>|^]|<[^-%&*+/;<=>|^]*>)*>)*>)*>)?)*)(?:\\s*(?:\\?\\s*)?\\[\\s*(?:,\\s*)*\\])*(?:\\s*\\?)?/
/\\s*#(?=\\w)(?:define|elif|else|endif|endregion|error|if|line|pragma|region|undef|warning)\\b/
...
/->|\\*/i
/^\\w+\$|(?:^|;\\s*)[A-Z]\\w*(?=\\()/
/\\s*#(?=\\w)(?:else|endif|if|light|line|nowarn)\\b/
...
/[^-\\0-\\x20"0-9A-Z_\\x7f-\\uffff]/i
/\\b(?:TERRAFORM|VAR|SELF|COUNT|MODULE|PATH|DATA|LOCAL)(?<=\\w)\\.[\\w*]+/i
...
/(?:[A-Z_\\xb5\\xc0-\\ufffd][\\w\\-.\\xb5\\xb7\\xc0-\\ufffd]*)?:(?:(?![\\-.])(?:[\\w\\-.:\\xb5\\xc0-\\ufffd]|%[\\dA-F]{2}|\\\\.)+)?/i
/(?:(?<!\\w)a|@prefix|@base)\\b|=/
...
/(?<!\\w)\\d{1,2}\\/\\d{1,2}\\/\\d{1,4}(?:(?::\\d{1,2}){3})?\\b/i
...
/@(?=\\w)(?:IB(?:Outlet|Designable|Action|Inspectable)|class_protocol|exported|noreturn|NS(?:Copying|Managed)|objc|UIApplicationMain|auto_closure)\\b/
