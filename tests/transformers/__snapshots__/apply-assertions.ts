...
module.exports[n`Transformers >> apply-assertions >> /(?=\d)\wa/ `] = lit`
/\da/
`;
...
module.exports[n`Transformers >> apply-assertions >> /(?=\w[^9])a\d/ `] = lit`
/a[0-8]/
`;

module.exports[n`Transformers >> apply-assertions >> /\da(?<=[^9]\w)/ `] = lit`
/[0-8]a/
`;

module.exports[n`Transformers >> apply-assertions >> /(?!4)(?=\d)\w(?<!2)a(?<=[^9]a)/ `] = lit`
/[0135-8]a/
`;

module.exports[n`Transformers >> apply-assertions >> /(?=a)\wa/ `] = lit`
/aa/
`;

module.exports[n`Transformers >> apply-assertions >> /(?=aa)\wa/ `] = lit`
/aa/
`;

module.exports[n`Transformers >> apply-assertions >> /(?=aaa)\wa/ `] = lit`
/aa(?=a)/
`;

module.exports[n`Transformers >> apply-assertions >> /(?!a)aa/ `] = lit`
/[]a/
`;
...
module.exports[n`Transformers >> apply-assertions >> /a$a/ `] = lit`
/a[]/
`;
...
module.exports[n`Transformers >> apply-assertions >> /(?!a|""")./s `] = lit`
/(?:[^"a]|"(?!""))/
`;
...
module.exports[n`Transformers >> apply-assertions >> /(?=foo)foo/i `] = lit`
/FOO/i
`;

module.exports[n`Transformers >> apply-assertions >> /(?!foo)bar/i `] = lit`
/BAR/i
`;

module.exports[n`Transformers >> apply-assertions >> /(?!food)foo/i `] = lit`
/FOO(?!D)/i
`;

module.exports[n`Transformers >> apply-assertions >> /(?!food)foot/i `] = lit`
/FOOT/i
`;

module.exports[n`Transformers >> apply-assertions >> /(?!food|foobar)foot/i `] = lit`
/FOOT/i
`;

module.exports[n`Transformers >> apply-assertions >> /(?!food)foo\w/i `] = lit`
/FOO[\dABCE-Z_]/i
`;

module.exports[n`Transformers >> apply-assertions >> /(?!food|foot)foo\w/i `] = lit`
/FOO[\dABCE-SU-Z_]/i
`;

module.exports[n`Transformers >> apply-assertions >> /(?!fo{6})foo\w/i `] = lit`
/FOO(?:[\dA-NP-Z_]|O(?!O{3}))/i
`;

module.exports[n`Transformers >> apply-assertions >> /\(\s*(?!\s)(?:[^()]|\([^()]*\))*?(?=\s*\))/ `] = lit`
/\(\s*(?:(?!\s)|(?:[^\s()]|\([^()]*\))(?:[^()]|\([^()]*\))*?)(?=\s*\))/
`;
...
module.exports[n`Transformers >> apply-assertions >> /(?!\d)(?<!\w)\w/ `] = lit`
/(?<!\w)[A-Z_]/i
`;

module.exports[n`Transformers >> apply-assertions >> /(?!\d)\w+/ `] = lit`
/[A-Z_]\w*/i
`;

module.exports[n`Transformers >> apply-assertions >> /\w+(?<!\d)/ `] = lit`
/\w*[A-Z_]/i
`;

module.exports[n`Transformers >> apply-assertions >> /(?=\da)\w+/ `] = lit`
/\d(?:a\w*|(?=a))/
`;

module.exports[n`Transformers >> apply-assertions >> /\w+(?<=a\d)/ `] = lit`
/(?:\w*a|(?<=a))\d/
`;

module.exports[n`Transformers >> apply-assertions >> /(?!\d)\w{1,2}/ `] = lit`
/[A-Z_]\w?/i
`;
...
module.exports[n`Transformers >> apply-assertions >> /(?=foobar)\w*\s/ `] = lit`
/foobar\w*\s/
`;

module.exports[n`Transformers >> apply-assertions >> /(?=foobar)\w*(?!\w)/ `] = lit`
/foobar\w*(?!\w)/
`;

module.exports[n`Transformers >> apply-assertions >> /(?=foobar)\w*(?![bfo])/ `] = lit`
/foob(?=ar)\w*(?![bfo])/
`;

module.exports[n`Transformers >> apply-assertions >> /(?=foobar)\w*$/ `] = lit`
/foobar\w*$/
`;

module.exports[n`Transformers >> apply-assertions >> /(?=fo{4})\w*$/ `] = lit`
/foooo\w*$/
`;

module.exports[n`Transformers >> apply-assertions >> /^\w*(?<=foobar)$/ `] = lit`
/^\w*foobar$/
`;
...
module.exports[n`Transformers >> apply-assertions >> /^\w+(?<!foobar)$/ `] = lit`
/^\w*(?:[\dA-Z_a-qs-z]|(?<!fooba)r)$/
`;

module.exports[n`Transformers >> apply-assertions >> /(?!\d)(?:\w+|:|123)/ `] = lit`
/(?:[A-Z_]\w*|:)/i
`;

module.exports[n`Transformers >> apply-assertions >> /(?=\d)\s*\w+/ `] = lit`
/(?:(?=[])\s+\w|\d)\w*/
`;

module.exports[n`Transformers >> apply-assertions >> /a$(?:a|b)/ `] = lit`
/a(?:[])/
`;
...
module.exports[n`Transformers >> apply-assertions >> /(a(?!b))+/ `] = lit`
/a+(?!b)/
`;
...
module.exports[n`Transformers >> apply-assertions >> /(a(?!b)){0,4}/ `] = lit`
/(?:a{1,4}(?!b))?/
`;

module.exports[n`Transformers >> apply-assertions >> /(a(?!b)){1,2}/ `] = lit`
/a{1,2}(?!b)/
`;
...
module.exports[n`Transformers >> apply-assertions >> /(?=a)[^]*/ `] = lit`
/(?:a[^]*|(?=a))/
`;
...
module.exports[n`Transformers >> apply-assertions >> /=begin\s[^]*^=end/m `] = lit`
/=begin(?:\s[^]*[\n\r\u2028\u2029]|[\n\r\u2028\u2029])=end/
`;

module.exports[n`Transformers >> apply-assertions >> /-?(?<!\w)\d+(?:\.\d+)?(?:E[-+]?\d+)?/i `] = lit`
/(?:-{1}|(?<!\w))\d+(?:\.\d+)?(?:E[-+]?\d+)?/i
`;

module.exports[n`Transformers >> apply-assertions >> /(?:a(?!\d)|foo(?=\w)|bar(?!\w)|b)\w+/i `] = lit`
/(?:A[A-Z_]|FOO\w|B\w)\w*/i
`;

module.exports[n`Transformers >> apply-assertions >> /(?:\[)(?!\d)\w+(?=\])/i `] = lit`
/(?:\[)[A-Z_]\w*(?=\])/i
`;

module.exports[n`Transformers >> apply-assertions >> /(?:^|[^&])(?<!\w)(?:TRUE|FALSE)/i `] = lit`
/(?:^(?<!\w)|[^\w&])(?:TRUE|FALSE)/i
`;

module.exports[n`Transformers >> apply-assertions >> /""((?!"").)*""/s `] = lit`
Start:                  /""(?:(?!"")[^])*""/
Pass 1
Con applyAssertions:    /""(?:[^"]|"(?!"))*""/
Qnt inline:             /""(?:[^"]|"(?!"))*""/
...
Pass 2
Con applyAssertions:    /""(?:[^"]|"[]*(?:(?!")[^"]))*""/
Qnt removeDeadBranches: /""(?:[^"]|"(?:[])*(?:(?!")[^"]))*""/
Con applyAssertions:    /""(?:[^"]|"(?:[])*(?:[^"]))*""/
Con inline:             /""(?:[^"]|"(?:[])*[^"])*""/
Con removeDeadBranches: /""(?:[^"]|"[^"])*""/
Pass 3
Final:                  /""(?:[^"]|"[^"])*""/
`;
...
module.exports[n`Transformers >> apply-assertions >> /(?:^|[^.]|\.\.\.\s*)(?<!\w)(?:as|async(?=\s*(?:function(?!\w)|\(|[\w$\xa0-\uffff]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|for|from|function|[gs]et(?=\s*[\w$[\xa0-\uffff])|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?!\w)/ `] = lit`
/(?:^(?<!\w)|[^\w.]|\.\.\.\s*)(?:as|async(?=\s*(?:function(?!\w)|\(|[\w$\xa0-\uffff]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|for|from|function|[gs]et(?=\s*[\w$[\xa0-\uffff])|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)(?!\w)/
`;
...
module.exports[n`Transformers >> apply-assertions >> /(?:[-!$%&*+/:<=>?@\\|~^]|\.\.|\.(?![)\]}]))+/ `] = lit`
Start:               /(?:[-!$%&*+/:<=>?@\\|~^]|\.\.|\.(?![)\]}]))+/
Pass 1
Con applyAssertions: /(?:[-!$%&*+/:<=>?@\\|~^]|\.\.|\.(?![)\]}])){1}(?:[-!$%&*+/:<=>?@\\|~^]|\.\.|\.(?:(?![)\]}])\.)*(?:(?![)\]}])(?:[-!$%&*+/:<=>?@\\|~^]|\.\.)))*(?:\.(?:(?![)\]}])\.)*(?![)\]}]))?/
Con inline:          /(?:[-!$%&*+/:<=>?@\\|~^]|\.\.|\.(?![)\]}]))(?:[-!$%&*+/:<=>?@\\|~^]|\.\.|\.(?:(?![)\]}])\.)*(?:(?![)\]}])(?:[-!$%&*+/:<=>?@\\|~^]|\.\.)))*(?:\.(?:(?![)\]}])\.)*(?![)\]}]))?/
Pass 2
Con applyAssertions: /(?:[-!$%&*+/:<=>?@\\|~^]|\.\.|\.(?![)\]}]))(?:[-!$%&*+/:<=>?@\\|~^]|\.\.|\.\.*(?:(?![)\]}])(?:[-!$%&*+/:<=>?@\\|~^]|\.\.)))*(?:\.(?:(?![)\]}])\.)*(?![)\]}]))?/
Con applyAssertions: /(?:[-!$%&*+/:<=>?@\\|~^]|\.\.|\.(?![)\]}]))(?:[-!$%&*+/:<=>?@\\|~^]|\.\.|\.\.*(?:(?:[-!$%&*+/:<=>?@\\|~^]|\.\.)))*(?:\.(?:(?![)\]}])\.)*(?![)\]}]))?/
...
module.exports[n`Transformers >> apply-assertions >> /(?:[a-z%]|(?<!\w)_+(?!\w))+/ `] = lit`
Start:                  /(?:[%a-z]|(?<!\w)_+(?!\w))+/
Pass 1
Con applyAssertions:    /(?:[%a-z]|(?<!\w)_+(?!\w)){1}(?:[%a-z]|(?:(?<!\w)_+)(?:(?!\w)(?<!\w)_+)*(?:(?!\w)[%a-z]))*(?:(?:(?<!\w)_+)(?:(?!\w)(?<!\w)_+)*(?!\w))?/
Con inline:             /(?:[%a-z]|(?<!\w)_+(?!\w))(?:[%a-z]|(?:(?<!\w)_+)(?:(?!\w)(?<!\w)_+)*(?:(?!\w)[%a-z]))*(?:(?:(?<!\w)_+)(?:(?!\w)(?<!\w)_+)*(?!\w))?/
Pass 2
Con applyAssertions:    /(?:[%a-z]|(?<!\w)_+(?!\w))(?:[%a-z]|(?:(?<!\w)_+)(?:(?<!\w)[]_*)*(?:(?!\w)[%a-z]))*(?:(?:(?<!\w)_+)(?:(?!\w)(?<!\w)_+)*(?!\w))?/
Con removeDeadBranches: /(?:[%a-z]|(?<!\w)_+(?!\w))(?:[%a-z]|(?:(?<!\w)_+)[]*(?:(?!\w)[%a-z]))*(?:(?:(?<!\w)_+)(?:(?!\w)(?<!\w)_+)*(?!\w))?/
Qnt removeDeadBranches: /(?:[%a-z]|(?<!\w)_+(?!\w))(?:[%a-z]|(?:(?<!\w)_+)(?:[])*(?:(?!\w)[%a-z]))*(?:(?:(?<!\w)_+)(?:(?!\w)(?<!\w)_+)*(?!\w))?/
Con applyAssertions:    /(?:[%a-z]|(?<!\w)_+(?!\w))(?:[%a-z]|(?:(?<!\w)_+)(?:[])*(?:%))*(?:(?:(?<!\w)_+)(?:(?!\w)(?<!\w)_+)*(?!\w))?/
Con inline:             /(?:[%a-z]|(?<!\w)_+(?!\w))(?:[%a-z]|(?<!\w)_+(?:[])*%)*(?:(?:(?<!\w)_+)(?:(?!\w)(?<!\w)_+)*(?!\w))?/
Con removeDeadBranches: /(?:[%a-z]|(?<!\w)_+(?!\w))(?:[%a-z]|(?<!\w)_+%)*(?:(?:(?<!\w)_+)(?:(?!\w)(?<!\w)_+)*(?!\w))?/
Con applyAssertions:    /(?:[%a-z]|(?<!\w)_+(?!\w))(?:[%a-z]|(?<!\w)_+%)*(?:(?:(?<!\w)_+)(?:(?<!\w)[]_*)*(?!\w))?/
Con removeDeadBranches: /(?:[%a-z]|(?<!\w)_+(?!\w))(?:[%a-z]|(?<!\w)_+%)*(?:(?:(?<!\w)_+)[]*(?!\w))?/
Qnt removeDeadBranches: /(?:[%a-z]|(?<!\w)_+(?!\w))(?:[%a-z]|(?<!\w)_+%)*(?:(?:(?<!\w)_+)(?:[])*(?!\w))?/
Con inline:             /(?:[%a-z]|(?<!\w)_+(?!\w))(?:[%a-z]|(?<!\w)_+%)*(?:(?<!\w)_+(?:[])*(?!\w))?/
Con removeDeadBranches: /(?:[%a-z]|(?<!\w)_+(?!\w))(?:[%a-z]|(?<!\w)_+%)*(?:(?<!\w)_+(?!\w))?/
Con applyAssertions:    /(?:[%a-z]|(?<!\w)_+(?!\w))(?:(?<!\w)(?:_+%(?<!\w))*(?:_+%))?(?:[%a-z]|(?:[%a-z](?<!\w))(?:_+%(?<!\w))*(?:_+%))*(?:(?<!\w)_+(?!\w))?/
Pass 3
Con applyAssertions:    /(?:[%a-z]|(?<!\w)_+(?!\w))(?:(?<!\w)(?:_+%)*(?:_+%))?(?:[%a-z]|(?:[%a-z](?<!\w))(?:_+%(?<!\w))*(?:_+%))*(?:(?<!\w)_+(?!\w))?/
Con inline:             /(?:[%a-z]|(?<!\w)_+(?!\w))(?:(?<!\w)(?:_+%)*_+%)?(?:[%a-z]|(?:[%a-z](?<!\w))(?:_+%(?<!\w))*(?:_+%))*(?:(?<!\w)_+(?!\w))?/
Con applyAssertions:    /(?:[%a-z]|(?<!\w)_+(?!\w))(?:(?<!\w)(?:_+%)*_+%)?(?:[%a-z]|(?:%)(?:_+%(?<!\w))*(?:_+%))*(?:(?<!\w)_+(?!\w))?/
Con applyAssertions:    /(?:[%a-z]|(?<!\w)_+(?!\w))(?:(?<!\w)(?:_+%)*_+%)?(?:[%a-z]|(?:%)(?:_+%)*(?:_+%))*(?:(?<!\w)_+(?!\w))?/
Con inline:             /(?:[%a-z]|(?<!\w)_+(?!\w))(?:(?<!\w)(?:_+%)*_+%)?(?:[%a-z]|%(?:_+%)*_+%)*(?:(?<!\w)_+(?!\w))?/
Pass 4
Final:                  /(?:[%a-z]|(?<!\w)_+(?!\w))(?:(?<!\w)(?:_+%)*_+%)?(?:[%a-z]|%(?:_+%)*_+%)*(?:(?<!\w)_+(?!\w))?/
`;
...
module.exports[n`Transformers >> apply-assertions >> /<title>(?:(?!<\/title>).)*<\/title>/s `] = lit`
Start:               /<title>(?:(?!<\/title>)[^])*<\/title>/
Pass 1
Con applyAssertions: /<title>(?:[^<]|<(?!\/title>))*<\/title>/
Qnt inline:          /<title>(?:[^<]|<(?!\/title>))*<\/title>/
Con applyAssertions: /<title>(?:[^<]|<(?:(?!\/title>)<)*(?:(?!\/title>)[^<]))*(?:<(?:(?!\/title>)<)*(?!\/title>)<|<)\/title>/
Pass 2
Con applyAssertions: /<title>(?:[^<]|<<*(?:(?!\/title>)[^<]))*(?:<(?:(?!\/title>)<)*(?!\/title>)<|<)\/title>/
Con applyAssertions: /<title>(?:[^<]|<<*(?:(?:[^/<]|\/(?!title>))))*(?:<(?:(?!\/title>)<)*(?!\/title>)<|<)\/title>/
Alt inline:          /<title>(?:[^<]|<<*(?:[^/<]|\/(?!title>)))*(?:<(?:(?!\/title>)<)*(?!\/title>)<|<)\/title>/
Con applyAssertions: /<title>(?:[^<]|<<*(?:[^/<]|\/(?!title>)))*(?:<<*(?!\/title>)<|<)\/title>/
Con applyAssertions: /<title>(?:[^<]|<<*(?:[^/<]|\/(?!title>)))*(?:<<*<|<)\/title>/
Pass 3
Final:               /<title>(?:[^<]|<<*(?:[^/<]|\/(?!title>)))*(?:<<*<|<)\/title>/
`;

module.exports[n`Transformers >> apply-assertions >> Prism regex snapshot `] = lit`
/<!--[^]*?-->/
/<\?[^]+?\?>/
/<!\[CDATA\[[^]*?\]\]>/i
/<!DOCTYPE(?:[^"'>[\]]|"[^"]*"|'[^']*')+(?:\[(?:<<*(?:[^!"'<\]]|!(?!--)|"[^"]*"|'[^']*'|<!--(?:[^-]|-(?:-+[^->]|[^-]))*(?:-(?:-+|)-|-)->)|[^"'<\]]|"[^"]*"|'[^']*'|<!--(?:[^-]|-(?:-+[^->]|[^-]))*(?:-(?:-+|)-|-)->)*(?:<<*\]|\])\s*)?>/i
...
/(?:^|[^-\w])(?:and|not|only|or)(?![-\w])/
/^(?:"(?:\\(?:\r\n|[^])|[^\n\r"\\])*"|'(?:\\(?:\r\n|[^])|[^\n\r'\\])*')$/
/<STYLE[^]*?>(?:<!\[CDATA\[(?:[^\]]|\](?:\]+[^>\]]|[^\]]))*(?:\](?:\]+|)\]|\])\]>|[^<]|<<*?(?:<!\[CDATA\[(?:[^\]]|\](?:\]+[^>\]]|[^\]]))*(?:\](?:\]+|)\]|\])\]>|[^!<]|!(?!\[CDATA\[)))*?(?:<<*?(?!!\[CDATA\[))??(?=<\/STYLE>)/i
/<!\[CDATA\[[^]*?\]\]>/i
/[^]+/
/\s*STYLE=(?:"(?:\\[^]|[^"\\])*"|'(?:\\[^]|[^'\\])*')/i
/^<!\[CDATA\[|\]\]>$/i
...
/[(),.:;[\]{}]/
/"(?:\\(?:\r\n|[^])|[^\n\r"\\])*"|'(?:\\(?:\r\n|[^])|[^\n\r'\\])*'/
/(?:\b(?:CLASS|INTERFACE|EXTENDS|IMPLEMENTS|TRAIT|INSTANCEOF|NEW)\s+|(?<!\w)CATCH\s+\()[\w.\\]+/i
/(?:^|[^\\])\/\*[^]*?(?:\*\/|$)/
/(?:^|[^:\\])\/\/.*/
/[.\\]/
/(?<!\w)[A-Z](?:[A-Z_]|\dx?)*\b/
/#?[$A-Z_a-z\xa0-\uffff][\w$\xa0-\uffff]*(?=\s*(?:\.\s*(?:apply|bind|call)\s*)?\()/
/\b(?:(?:0[Xx](?:[\dA-Fa-f](?:_[\dA-Fa-f])?)+|0[Bb](?:[01](?:_[01])?)+|0[Oo](?:[0-7](?:_[0-7])?)+)n?|(?:\d(?:_\d)?)+n|NaN|Infinity)\b|(?:\b(?:\d(?:_\d)?)+\.?(?:\d(?:_\d)?)*|(?<!\w)\.(?:\d(?:_\d)?)+)(?:[Ee][-+]?(?:\d(?:_\d)?)+)?/
/--|\+\+|\*\*=?|=>|&&=?|\|\|=?|[!=]==|<<=?|>>>?=?|[-!%&*+/<=>|^]=?|\.{3}|\?\?=?|\?\.?|[:~]/
...
/(?:^|\})\s*(?:catch|finally)\b/
/(?:^|[^.]|\.\.\.\s*)\b(?:as|async(?=\s*(?:function(?!\w)|\(|[\w$\xa0-\uffff]|$))|await|break|case|class|const|continue|debugger|default|delete|do|else|enum|export|extends|for|from|function|(?:get|set)(?=\s*[\w$[\xa0-\uffff])|if|implements|import|in|instanceof|interface|let|new|null|of|package|private|protected|public|return|static|super|switch|this|throw|try|typeof|undefined|var|void|while|with|yield)\b/
/^\`|\`$/
/(?:^|[^\\])(?:\\{2})*\$\{(?:[^{}]|\{(?:[^{}]|\{[^}]*\})*\})+\}/
/^\$\{|\}$/
/<SCRIPT[^]*?>(?:<!\[CDATA\[(?:[^\]]|\](?:\]+[^>\]]|[^\]]))*(?:\](?:\]+|)\]|\])\]>|[^<]|<<*?(?:<!\[CDATA\[(?:[^\]]|\](?:\]+[^>\]]|[^\]]))*(?:\](?:\]+|)\]|\])\]>|[^!<]|!(?!\[CDATA\[)))*?(?:<<*?(?!!\[CDATA\[))??(?=<\/SCRIPT>)/i
/^\*.*/m
/\`(?:\\.|[^\n\r\\\\\`])*\`|'(?:\\.|[^\n\r'\\])*'/
/(?<!\w)\d+(?!\w)/
/[(),.:]/
...
/(?<!\w)[A-Z_]\w*(?=\s*::\s*~\w+\s*\()/i
/\w+(?=\s*<(?:[^<>]|<(?:[^<>]|<[^<>]*>)*>)*>\s*::\s*\w+\s*\()/
/(?:(?<!\w)0B['01]+|(?<!\w)0X(?:[\d'A-F]+\.?[\d'A-F]*|\.[\d'A-F]+)(?:P[-+]?[\d']+)?|(?:(?:(?<!\w)\d|(?<=\w)')[\d']*\.?[\d']*|(?<!\w)\.[\d']+)(?:E[-+]?[\d']+)?)[FLU]*/i
/^#/
/##|\\(?=[\n\r])/
/(?<!\w)[A-Z_]\w*\b(?!\s*::)/i
/\b(?:class|concept|enum|struct|typename)\s+(?!(?<!\w)(?:alignas|alignof|asm|auto|bool|break|case|catch|char|char8_t|char16_t|char32_t|class|compl|concept|const|consteval|constexpr|constinit|const_cast|continue|co_await|co_return|co_yield|decltype|default|delete|do|double|dynamic_cast|else|enum|explicit|export|extern|float|for|friend|goto|if|inline|int|int8_t|int16_t|int32_t|int64_t|uint8_t|uint16_t|uint32_t|uint64_t|long|mutable|namespace|new|noexcept|nullptr|operator|private|protected|public|register|reinterpret_cast|requires|return|short|signed|sizeof|static|static_assert|static_cast|struct|switch|template|this|thread_local|throw|try|typedef|typeid|typename|union|unsigned|using|virtual|void|volatile|wchar_t|while)(?:(?<!\w)\w|(?<=\w)(?!\w)))\w+/
/^#\s*[a-z]+/
/\S[^]*/
/^#\s*include\s*<[^>]+>/
/%.*/
...
/(?:(?<!\w)|-)\d+(?!\w)/
/['(),]/
/^IF(?!\w)|\b(?:NOT|CMDEXTVERSION|DEFINED|ERRORLEVEL|EXIST)\b/i
...
/\b(?:false|true)\b/
/(?<!\w)0B[01][01_]*L?\b|(?<!\w)0X[\dA-F_]*\.?[-\d+A-FP_]*(?:[-+](?=\w)|[\dA-FP_](?!\w))|(?:(?<!\w)\d[\d_]*\.?[\d_]*|(?<!\w)\.\d[\d_]*)(?:E[-+]?\d[\d_]*)?[DFLS]?/i
...
/>|\+|~|\|\|/
/[(),]/
/\b(?:RGB|HSL)\(\s*\d{1,3}\s*,\s*\d{1,3}%?\s*,\s*\d{1,3}%?\s*\)(?!\w)|\b(?:RGB|HSL)A\(\s*\d{1,3}\s*,\s*\d{1,3}%?\s*,\s*\d{1,3}%?\s*,\s*(?:0|0?\.\d+|1)\s*\)(?!\w)/i
/\[(?:[^"'[\]]|"(?:\\(?:\r\n|[^])|[^\n\r"\\])*"|'(?:\\(?:\r\n|[^])|[^\n\r'\\])*')*\]/
/[-\w]+(?=\()/
/^\[|\]$/
/[$*|~^]?=/
...
/\|[=|]?|&[&=]?|\+[+=]?|-[-=]?|\.?\.\.|=[=>]?|!(?:i[ns](?!\w)|<>?=?|>=?|=)?|(?<!\w)i[ns](?!\w)|(?:<[<>]?|>>?>?|\^\^|[%*/~^])=?/
/\b(?:[A-D][HLX]|E[A-D]X|E?(?:BP|SP|DI|SI)|[C-GS]S|CR[0234]|DR[0-367]|TR[3-7]|X?MM[0-7]|R[A-D]X|[BS]PL|R[BS]P|[DS]IL|R[DS]I|R(?:[89]|1[0-5])[BDW]?|XMM(?:[89]|1[0-5])|YMM(?:1[0-5]|\d))\b|(?<!\w)ST(?:\([0-7]\)|(?!\w))/
/(?<!\w)0X\.?[\dA-F_]+(?:\.(?:[\dA-F_]+|(?!\.)))?(?:P[-+]?[\dA-F_]+)?[FILU]*/i
/^\s*#!.+/
/(?:^|[^\\])(?:\/\+(?:\/\+(?:[^+]|\+\+*[^+/])*(?:\+\+*|)\+\/|[^/]|\/\/*?(?:\/\+(?:[^+]|\+\+*[^+/])*(?:\+\+*|)\+\/|[^+/]))*?\+\/|\/\/.*|\/\*[^]*?\*\/)/
/(?<!\w)[rx]"(?:\\[^]|[^"\\])*"[cdw]?|(?<!\w)q"(?:\[[^]*?\]|\([^]*?\)|<[^]*?>|\{[^]*?\})"|(?<!\w)q"[A-Z_a-z]\w*(?:$^|[\n\r\u2028\u2029](?:|[^]*?[\n\r\u2028\u2029]))[]Unknown:\\1[]"|(?<!\w)q".[^]*?[]Unknown:\\2[]"|'(?:\\(?:\W|\w+)|[^\\])'|(?:"(?:\\[^]|[^"\\])*"|\`(?:\\[^]|[^\\\\\`])*\`)[cdw]?/m
/(?<!\w)q\{(?:\{[^{}]*\}|[^{}])*\}/
...
/\b(?:Some|None)\b/
/\b(?:False|True)\b/
/(?<!\w)NaN(?!\w)|(?:-|(?<!\w))Infinity(?!\w)|[-+]?\b(?:0x[\dA-Fa-f]+|\d+(?:\.\d+)?(?:e[-+]?\d+)?)\b/
/\/\\|\/\/\\\\|&&|\|\||[!=]=|===|\/\/|->|\+\+|::|[#*+:<=>?@\\|\u03bb\u2192\u2227\u2261\u2a53\u2afd]/
/\.\.|[(),./[\]{}]/
/(?<!\w)[A-Z]\w*\b/
/"(?:[^"\\]|\\.)*"|''(?:'[^']|[^']|'''|''\$\{)*''(?!'|\$)/
...
/\\\\|\|\.\.\||\.\.|\/[/=~]?|[<>]=?|[-*+=~^]/
/(?<!\w)[A-Z][\dA-Z_]*\b/
/(?<!\w)0[BCX][\dA-F](?:_*[\dA-F])*\b/i
/(?:(?<!\w)\d(?:_*\d)*)?\.(?:(?:\d(?:_*\d)*)?E[-+]?)?\d(?:_*\d)*\b|(?<!\w)\d(?:_*\d)*\b\.?/i
/"[^[]*\[[^]*?\][]Unknown:\\1[]"/
/"[^{]*\{[^]*?\}[]Unknown:\\1[]"/
/"(?:%\s*\n\s*%|%.|[^\n\r"%])*"/
/^#[^]*/
...
/^#!.+|--(?:\[=*\[[^]*?\][]Unknown:\\1[]\]|.*)/m
/(?<!\w)0X[\dA-F]+\.?[\dA-F]*(?:P[-+]?\d+)?\b|(?<!\w)\d+(?:\.(?!\w)|\.?\d*(?:E[-+]?\d+)?\b)|(?<!\w)\.\d+(?:E[-+]?\d+)?\b/i
...
/\[[^[\]]+\]$/
/[[\]]/
/\b(?:let|return|use|yield)(?:!(?!\w)|(?<!\w)(?=\w)|(?<=\w)(?!\w))|\b(?:abstract|and|as|assert|base|begin|class|default|delegate|do|done|downcast|downto|elif|else|end|exception|extern|false|finally|for|fun|function|global|if|in|inherit|inline|interface|internal|lazy|match|member|module|mutable|namespace|new|not|null|of|open|or|override|private|public|rec|select|static|struct|then|to|true|try|type|upcast|val|void|when|while|with|asr|land|lor|lsl|lsr|lxor|mod|sig|atomic|break|checked|component|const|constraint|constructor|continue|eager|event|external|fixed|functor|include|method|mixin|object|parallel|process|protected|pure|sealed|tailcall|trait|virtual|volatile)\b/
/&&&|<<<|>>>|\^\^\^|~~~|&&|\*\*|\.\.|::|<<|>>|<-|->|[!:=]=|<?\|{1,3}>?|\??(?:<=|>=|<>|[-%*+/<=>])\??|[!&?^]|~[-+~]|:>|:\?>?/
/\[<.+?>\]/
...
/(?<!\w)\d+(?:[ILlsy]|u[lsy]?|UL)?\b/
/[A-Z_]\w*(?=\s*\{)/i
/(?:^|[^\\])\(\*[^]*?\*\)/
/^\[<|>\]$/
/->|\*/
/^\w+$|(?:^|;\s*)[A-Z]\w*(?=\()/
/\s*#(?:else|endif|if|light|line|nowarn)\b/
...
/(?:^|[^\w$](?=\w)|\w(?!\w))(?:type|opaque|declare|Class)\b(?!\$)/
/(?:^|[^\w$])\$(?:await|Diff|Exact|Keys|ObjMap|PropertyType|Shape|Record|Supertype|Subtype|Enum)\b(?!\$)/
/\.(?:TRUE|FALSE)\.(?:_\w+)?/i
...
/[(),.:;[\]{}]/
/@?(?:(?:"(?:[^\n"\\]|\\[^])*"|'(?:[^\n'\\]|\\[^])*')(?!"|')|"""(?:[^\\]|\\[^])*?""")/
/(?:^(?:class_name|class|extends)[\t ]+|^export\([\t ]*|(?<!\w)as[\t ]+|(?:\b(?:const|var)[\t ]|[(,])[\t ]*\w+[\t ]*:[\t ]*|->[\t ]*)[A-Z_a-z]\w*/m
...
/(?<!\w)this(?!\w)|\b(?:abstract|as|break|case|cast|catch|class|continue|default|do|dynamic|else|enum|extends|extern|from|for|function|if|implements|import|in|inline|interface|macro|new|null|override|public|private|return|static|super|switch|throw|to|try|typedef|using|var|while)(?!\.)\b/
/\.{3}|\+\+?|-[->]?|[!=]=?|&&?|\|\|?|<[<=]?|>[=>]?|[%*/~^]/
/"(?:[^"\\]|\\[^])*"|'(?:[^'\\]|\\[^])*'/
/~\/(?:[^\n\r/\\]|\\.)+\/[gimsu]*/
/#\w+/
...
/\b(?:TERRAFORM|VAR|SELF|COUNT|MODULE|PATH|DATA|LOCAL)\.[\w*]+/i
...
/[(),.:;{}]/
/"[^"]*"/
/^[\t ]*(?:VOLUME|BOOK|PART(?! OF)|CHAPTER|SECTION|TABLE)(?:(?<!\w)\w|(?<=\w)[^\w\n\r\u2028\u2029]).*/im
/(?:^|[^-])(?:(?<!\w)\d+(?:\.\d+)?(?:\^\d+)?\w*|\b(?:ONE|TWO|THREE|FOUR|FIVE|SIX|SEVEN|EIGHT|NINE|TEN|ELEVEN|TWELVE))\b(?!-)/i
...
/\b_?(?:\d(?:\d+|(?!:))(?:\.\d+)?(?:(?:[ejpx]|ad|ar)_?\d+(?:\.\d+)?)*(?:b_?[\da-z]+(?:\.[\da-z]+)?)?|_(?!\w)(?!\.))/
/[=a][.:]|_\./
/'(?:''|[^\n\r'])*'/
...
/(?<!\w)0B[01][01_]*L?\b|(?<!\w)0X[\dA-F_]*\.?[-\d+A-FP_]*(?:[-+](?=\w)|[\dA-FP_](?!\w))|(?:(?<!\w)\d[\d_]*\.?[\d_]*|(?<!\w)\.\d[\d_]*)(?:E[-+]?\d[\d_]*)?[DFL]?/i
/"""[\t ]*[\n\r](?:(?:"|"")?(?:\\.|[^"\\]))*"""/
/\b(?:exports|import(?:\s+static)?|module|open|opens|package|provides|requires|to|transitive|uses|with)\s+(?!(?<!\w)(?:abstract|assert|boolean|break|byte|case|catch|char|class|const|continue|default|do|double|else|enum|exports|extends|final|finally|float|for|goto|if|implements|import|instanceof|int|interface|long|module|native|new|null|open|opens|package|private|protected|provides|public|record|requires|return|short|static|strictfp|super|switch|synchronized|this|throw|throws|to|transient|transitive|try|uses|var|void|volatile|while|with|yield)(?:(?<!\w)\w|(?<=\w)(?!\w)))[a-z]\w*(?:\.[a-z]\w*)*\.?/
/<(?:[\s\w&,.?]|<(?:[\s\w&,.?]|<(?:[\s\w&,.?]|<[\s\w&,.?]*>)*>)*>)*>/
/(?<!\w)[A-Z](?:\w*[a-z]\w*)?\b/
/(?<!\w)[A-Z]\w*(?=\s+\w+\s*[(),;=])/
/(?:^|[^.])(?:<<=?|>>>?=?|->|--|\+\+|&&|\|\||::|[:?~]|[-!%&*+/<=>|^]=?)/m
...
/\b(?:class|extends|implements|instanceof|interface|new|type)\s+(?:[$A-Z_a-jl-z\xa0-\uffff]|k(?!eyof(?!\w)))[\w$\xa0-\uffff]*(?:\s*<(?:[^<>]|<(?:[^<>]|<[^<>]*>)*>)*>)?/
...
/@+\w+/
/[-+]?\b(?:NaN|Infinity|0x[\dA-Fa-f]+)\b|[-+]?(?:(?<!\w)\d+\.?\d*|(?<!\w)\.\d+)(?:[Ee][-+]?\d+(?!\w))?/
/"(?:\\(?:\r\n?|\n|.)|[^\n\r"\\])*"|'(?:\\(?:\r\n?|\n|.)|[^\n\r'\\])*'/
/(?:"(?:\\(?:\r\n?|\n|.)|[^\n\r"\\])*"|'(?:\\(?:\r\n?|\n|.)|[^\n\r'\\])*')(?=\s*:)/
/[$A-Z_a-z\xa0-\uffff][\w$\xa0-\uffff]*(?=\s*:)/
/[$A-Z_a-z\xa0-\uffff][\w$\xa0-\uffff]*(?=\s*\()/
...
/(?<!\w)0B[01]+(?!\w)|(?<!\w)0X[\dA-F]*\.?[-\dA-FP]*(?:-(?=\w)|[\dA-FP](?!\w))|(?:(?<!\w)\d+\.?\d*|(?<!\w)\.\d+)(?:E[-+]?\d+)?[DF]?/i
/(?:^|[^.])(?:\+[+=]?|-[-=]?|!=?|<<?=?|>>?>?=?|==?|&[&=]?|\|[=|]?|\*=?|\/=?|%=?|\^=?|[:?~])/m
...
/(?:^|[^"])(?:"""(?:\\[^]|[^"\\]|"(?:"(?!"))?(?:\\[^]|[^"\\]))*"""|"(?:\\[^]|[^"\\])*")(?!")/
/\\[^\s),;\]}]+/
/(?:^|[^-\n\r\u2028\u2029])\b(?:break|case|catch|class|const|continue|default|do|else|extends|fallthrough|finally|for(?: ever)?|function|if|implements|it|let|loop|new|null|otherwise|own|return|super|switch|that|then|this|throw|try|unless|until|var|void|when|while|yield)(?!-)\b/m
...
/(?<!\w)[_a-z][\d_a-z]*\b/
/(?:[-+]|(?<!\w))\d+(?:\.\d+)?(?:[Ee][-+]?\d+)?\b|(?<!\w)0x[\dA-Fa-f]+(?!\w)|(?<!\w)0xK[\dA-Fa-f]{20}(?!\w)|(?<!\w)0x[LM][\dA-Fa-f]{32}(?!\w)|(?<!\w)0xH[\dA-Fa-f]{4}(?!\w)/
/[!()*,.;<=>[\]{}]/
...
/(?:^|[^\\])#(?:\\(?:\r\n|[^])|[^\n\r\\])*/
/^[^\n\r:=]+(?=\s*:(?!=))/m
/-include(?!\w)|\b(?:define|else|endef|endif|export|ifn?def|ifn?eq|include|override|private|sinclude|undefine|unexport|vpath)\b/
/\$+(?:[^\s#():={}]+|(?=[({]))/
...
/\+[+=]?|-[-=]?|&&|\|\||[<>]=|[!*/=]=?|[%^]/
/::.+/
/@proof(?!\w)|\b(?:according|aggregate|all|and|antonym|are|as|associativity|assume|asymmetry|attr|be|begin|being|by|canceled|case|cases|clusters?|coherence|commutativity|compatibility|connectedness|consider|consistency|constructors|contradiction|correctness|def|deffunc|define|definitions?|defpred|do|does|equals|end|environ|ex|exactly|existence|for|from|func|given|hence|hereby|holds|idempotence|identity|iff?|implies|involutiveness|irreflexivity|is|it|let|means|mode|non|not|notations?|now|of|or|otherwise|over|per|pred|prefix|projectivity|proof|provided|qua|reconsider|redefine|reduce|reducibility|reflexivity|registrations?|requirements|reserve|sch|schemes?|section|selector|set|sethood|st|struct|such|suppose|symmetry|synonym|take|that|the|then|theorems?|thesis|thus|to|transitivity|uniqueness|vocabular(?:y|ies)|when|where|with|wrt)\b/
/\w+(?=:)/
/\.\.\.|->|&|\.?=/
/\(#|#\)|[(),:;[\]{}]/
/\$(?:10|\d)/
...
/@@?\w*/
/(?:(?<!\w)\.\d+|(?<!\w)\d+\.\d+|(?<!\w)\d+(?=[Ee]))(?:[Ee][-+]?\d+)?\b|\b(?:0x[\dA-Fa-f]+|\d+)(?:U?LL)?\b/
/\.{3}|[-=]>|~=|(?:[-!%*+/<=>]|\.\.)=?|[#:^]|\b(?:and|or)\b=?|(?<!\w)not(?!\w)/
/[(),.[\\\]{}]/
/(?<!\w)[A-Z_]\w*(?=:)|:[A-Z_]\w*/i
...
/(?:EXTERN|GLOBAL)[^\n\r;]*/i
/(?:CPU|FLOAT|DEFAULT).*$/m
/\b(?:ST\d|[XYZ]MM\d\d?|[CDT]R\d|R\d\d?[BDW]?|[ER]?[A-D]X|[A-D][HL]|[ER]?(?:BP|SP|SI|DI)|[C-GS]S)\b/i
/^\s*SECTION\s*[.A-Z]+:?/im
/[-(),:=[\]{}]/
...
/\`[^\n\r\`]+\`/
/(?:^|[([{](?=\.\.)|[^\n\r([{\u2028\u2029]|[([{](?!\.))(?:(?:[-!$%&*+/:<=>?@\\|~^]|\.\.|\.(?![)\]}]))(?:[-!$%&*+/:<=>?@\\|~^]|\.\.|\.\.*(?:[-!$%&*+/:<=>?@\\|~^]|\.\.))*(?:\.\.*(?![)\]}]))?|\b(?:and|div|of|or|in|is|isnot|mod|not|notin|shl|shr|xor)\b)/m
/\*$/
/\`/
/\/\*[^]*?\*\/|#.*/
...
/\^(?:["$'():;@[\]\^{}]|#[\dA-F]*)/i
/\b(?:0X[\dA-F]+|\d+\.?\d*(?:E[-+]?\d+)?)\b/i
/[%*+/\\~]|!(?:\|\|?|=)?|&&?|\|\|?|==|<[<=]?|>[=>]?|-[df]?|\b(?:def|eq|ge|gt|in|is|le|lt|ne)\b/
/\.|:+/
/(?:^|[^\^])(?:"(?:[^"^]|\^[^])*"|'(?:[^'^]|\^[^])*')/
/^@(?:GET_|SET_)/
/\(\.|\.\)|[(),.:;[\]]/
...
/-[ABCMORSTWXb-gklopr-uwxz](?!\w)|\+[+=]?|-[-=>]?|\*\*?=?|\/\/?=?|=[=>~]?|~[=~]?|\|\|?=?|&&?=?|<(?:=>?|<=?)?|>>?=?|![=~]?|[%^]=?|\.(?:=|\.\.?)?|[?\\]|(?<!\w)x(?:=|(?!\w))|\b(?:lt|gt|le|ge|eq|ne|cmp|not|and|or|xor)\b/
/[$%&*@]\{\^[A-Z]+\}/
/[$%&*@]\^[A-Z_]/
/[$%&*@]#?(?=\{)/
/[$%&*@]#?(?:(?:::)*'?[$A-Z_][\w$]*)+(?:::)*/i
...
/(?:^|[^\\])(?:\/\*[^]*?\*\/|\/\/.*)/
/#"(?:[^\n\r"]|"")*"(?!")/
/(?<!\w)Day\.(?:Sunday|Monday|Tuesday|Wednesday|Thursday|Friday|Saturday)\b/
/(?<!\w)TraceLevel\.(?:Critical|Error|Information|Verbose|Warning)\b/
/(?<!\w)Occurrence\.(?:First|Last|All)\b/
/(?<!\w)Order\.(?:Ascending|Descending)\b/
/(?<!\w)RoundingMode\.(?:AwayFromZero|Down|ToEven|TowardZero|Up)\b/
/(?<!\w)MissingField\.(?:Error|Ignore|UseNull)\b/
/(?<!\w)QuoteStyle\.(?:Csv|None)\b/
/(?<!\w)JoinKind\.(?:Inner|LeftOuter|RightOuter|FullOuter|LeftAnti|RightAnti)\b/
/(?<!\w)GroupKind\.(?:Global|Local)\b/
/(?<!\w)ExtraValues\.(?:List|Ignore|Error)\b/
/(?<!\w)JoinAlgorithm\.(?:Dynamic|PairwiseHash|SortMerge|LeftHash|RightHash|LeftIndex|RightIndex)\b/
/(?<!\w)JoinSide\.(?:Left|Right)\b/
/(?<!\w)Precision\.(?:Double|Decimal)\b/
/(?<!\w)RelativePosition\.From(?:End|Start)\b/
/(?<!\w)TextEncoding\.(?:Ascii|BigEndianUnicode|Unicode|Utf8|Utf16|Windows)\b/
/\b(?:Any|Binary|Date|DateTime|DateTimeZone|Duration|Int8|Int16|Int32|Int64|Function|List|Logical|None|Number|Record|Table|Text|Time)\.Type(?!\w)/
/(?:^|[^\w#.])[.A-Z_][\w.]*(?=\s*\()/i
...
/(?<!\w)0X[\dA-F]+(?!\w)|(?:[-+]?(?:(?<!\w)\d+\.|(?<!\w))\d+|[-+]\.\d+|(?:^(?<!\w)|[^\w.])\.\d+)(?:E[-+]?\d+)?\b/i
/\[[A-Z](?:\[(?:\[[^\]]*\]|[^[\]])*\]|[^[\]])*\]/i
/\$(?:TRUE|FALSE)\b/i
/\$\w+(?!\w)/
...
/\b(?:[A-WYZ][\dA-Z_]|X(?:[\dA-LN-Z_]|M(?!L(?!\w))))[\dA-Z_]*\b/
/<[<=]?|>[=>]?|&&?|\|\|?|[%?]|[-!*+/=]=?/
...
/^[\t ]*(?:block|extends|include|append|prepend)(?:(?<!\w)\w|(?<=\w)[^\w\n\r\u2028\u2029]).*/m
/^[\t ]*script(?:(?:&[^(]+)?\([^)]+\))*[\t ]+.+/m
/^[\t ]*(?:[\w#.][\w#\-.]*[-\w]|\w)(?:(?:&[^(]+)?\([^)]+\))*\/?[\t ]+.+/m
/^[\t ]*(?:[\w#.][\w#\-.]*[-\w]|\w)(?:(?:&[^(]+)?\([^)]+\))*\/?:?/m
/^[\t ]*mixin .+/m
...
/(?<!\w)\d+(?:%|[a-z]+)/
/~|[!%+/<=>?]=?|[-:]=|\*[*=]?|\.{2,3}|&&|\|\||(?<!\w)-(?!\w)|\b(?:and|in|is(?: a| defined| not|nt)?|not|or)\b/
/^(?:\{\{|\{%)-?/
/^["']|["']$/
...
/"(?:\$\{(?:[^"'}]|"(?:[^"\\]|\\[^])*"|'(?:[^'\\]|\\[^])*')+\}|[^"\\]|\\[^])*"|'(?:\$\{(?:[^"'}]|"(?:[^"\\]|\\[^])*"|'(?:[^'\\]|\\[^])*')+\}|[^'\\]|\\[^])*'/
/\$(?:::)?\w+(?:::\w+)*/
/\b(?:contain|debug|err|fail|include|info|notice|realize|require|tag|warning)\b|(?<!\w)[A-Z_a-z]\w*(?=\()/
...
/(?:[\x21-\x27*+,\-./:<=>?@\\\\\`|~\xa1-\xbf\xd7-\xf7\u20d0-\u2bff^]|(?<!\w)_+(?!\w))(?:(?<!\w)(?:_+[\x21-\x27*+,\-./:<=>?@\\\\\`|~\xa1-\xbf\xd7-\xf7\u20d0-\u2bff^])*_+[\x21-\x27*+,\-./:<=>?@\\\\\`|~\xa1-\xbf\xd7-\xf7\u20d0-\u2bff^])?(?:[\x21-\x27*+,\-./:<=>?@\\\\\`|~\xa1-\xbf\xd7-\xf7\u20d0-\u2bff^]|[\x21-\x27*+,\-./:<=>?@\\\\\`|~\xa1-\xbf\xd7-\xf7\u20d0-\u2bff^](?:_+[\x21-\x27*+,\-./:<=>?@\\\\\`|~\xa1-\xbf\xd7-\xf7\u20d0-\u2bff^])*_+[\x21-\x27*+,\-./:<=>?@\\\\\`|~\xa1-\xbf\xd7-\xf7\u20d0-\u2bff^])*(?:(?<!\w)_+(?!\w))?|\b(?:and|div|mod|not|or)\b/
/[(),;[\]{|}]/
/%<[^]+?%>/
/(?:\.\.)?(?:\b(?:INF|NAN)\b|(?<!\w)0X[\dA-F]+|(?:\b(?:0B)?\d+(?:\.\d)?|(?<!\w)\.\d)\d*(?:E[-+]?\d+)?L?)/i
/(?<!\w)__[A-Z]+__(?!\w)/i
/^%< *-\*-.+?-\*-/
/^%<.*|%>$/
/%< *-\*- *C\d* *-\*-[^]+?%>/i
...
/(?:@\*?|\?|\*)\w+|-[->]?|\+\+?|!=?|<<?=?|>>?=?|==?|&&?|\|?\||[%*/?@~^]/
/^\s*!.*/m
/\b(?:ST\d|[XYZ]MM\d\d?|[CDT]R\d|R\d\d?[BDW]?|[ER]?[A-D]X|[A-D][HL]|[ER]?(?:BP|SP|SI|DI)|[C-GS]S|MM\d+)\b/i
/(?:(?<!\w)(?=\w)|(?<=\w)(?!\w)|-|(?=\$))(?:0[HX][\dA-F]*\.?[\dA-F]+(?:P[-+]?\d+)?|\d[\dA-F]+[HX]|\$\d[\dA-F]*|0[OQ][0-7]+|[0-7]+[OQ]|0[BY][01]+|[01]+[BY]|0[DT]\d+|\d*\.?\d+(?:\.?E[-+]?\d+)?[DT]?)\b/i
/[!$%&*+,\-./:<=>[\]|]/
/\s*!\s*J[A-Z]+\s+@[BF]/i
...
/\b(?:[Tt]rue|[Ff]alse)\b/
/(?:\b(?:0[BO])?(?:\d|0X[\dA-F])[\dA-F]*\.?\d*|(?<!\w)\.\d+)(?:E[-+]?\d+)?J?/i
...
/[(),.:[\]\`]|->/
/[-%*+/]|==?=?|[!<>]=?|&&|\|\|?/
/(?<!\w)is\s+(?:not\s+)?(?:div|even|odd)(?:\s+by)?\b/
...
/=>|->|:=|=:|\*\*|\+\+|--|\|\||&&|<<=?|>>=?|[-!%&*+/<=>|^]=?|[?~]/
/\b(?:contract|enum|interface|library|new|struct|using)\s+[$A-Z_a-z][\w$]*/
/(?:[<>]=?|\^)\d+\.\d+\.\d+(?!\w)/
/\b(?:FALSE|TRUE)\b/
/^[\t ]*(?:[A-Z]\w*\b(?=.*(?:\r\n?|\n)(?:[]Unknown:\\1[][\t ].*(?:\r\n?|\n))*[]Unknown:\\1[]End[]Unknown:\\2[][\t ]*$)|End[A-Z]\w*(?=[\t ]*$))/m
/^[\t ]*[^\n\r"#()=]*[^\s"#()=](?=\s*=)/m
/\{[\dA-F]{8}-[\dA-F]{4}-[\dA-F]{4}-[\dA-F]{4}-[\dA-F]{12}\}/i
/(?<!\w)\d+(?:\.\d+)?(?:[Ee][-+]?\d+)?\b|(?<!\w)0x[\dA-F]+(?!\w)/
/\?:?|<=?|>=?|==?|!=|[-%*+/]|\b(?:and|not|or)\b/
/[(),.:[\]{|}]/
...
/%[IMQ][BDLWX][\d.]*|%[IQ][\d.]*/
/\b(?:16#[\dA-F]+|2#[01_]+|0X[\dA-F]+)\b|\b(?:T|D|DT|TOD)#[\d:DHMS_]*|\b[A-Z]*#[\d,._]*|(?:(?<!\w)\d+\.?\d*|(?<!\w)\.\d+)(?:E[-+]?\d+)?/i
/\b(?:TRUE|FALSE|NULL)\b/
...
/@(?:IB(?:Outlet|Designable|Action|Inspectable)|class_protocol|exported|noreturn|NS(?:Copying|Managed)|objc|UIApplicationMain|auto_closure)\b/
...
/"[^"\\]*(?:\\[^][^"\\]*)*"/
/^(?:\[%|%%)-?|-?%\]$/
/(?<!\w)[A-Z]\w*(?:\s*\.\s*(?:\d+|\$?[A-Z]\w*))*\b/i
/\$[A-Z]\w*(?:\.(?:\d+|\$?[A-Z]\w*))*/i
/(?<!\w)0(?:x[\dA-Za-z]+(?:_[\dA-Za-z]+)*|o[0-7]+(?:_[0-7]+)*|b[01]+(?:_[01]+)*)\b|(?:[-+]|(?<!\w))\d+(?:_\d+)*(?:\.\d+(?:_\d+)*)?(?:[Ee][-+]?\d+(?:_\d+)*)?\b|[-+]?\b(?:inf|nan)\b/
/[,.=[\]{}]/
/^\s*\[\s*(?:\[\s*)?(?:[-\w]+|'[^\n\r']*'|"(?:\\.|[^\n\r"\\])*")(?:\s*\.\s*(?:[-\w]+|'[^\n\r']*'|"(?:\\.|[^\n\r"\\])*"))*(?=\s*\])/m
/(?:^\s*|[,{]\s*)(?:[-\w]+|'[^\n\r']*'|"(?:\\.|[^\n\r"\\])*")(?:\s*\.\s*(?:[-\w]+|'[^\n\r']*'|"(?:\\.|[^\n\r"\\])*"))*(?=\s*=)/m
/"""(?:\\[^]|[^\\])*?"""|'''[^]*?'''|'[^\n\r']*'|"(?:\\.|[^\n\r"\\])*"/
/(?<!\w)\d{4}-\d{2}-\d{2}(?:[\sT]\d{2}:\d{2}:\d{2}(?:\.\d+)?(?:Z|[-+]\d{2}:\d{2})?)?\b/i
/(?<!\w)\d{2}:\d{2}:\d{2}(?:\.\d+)?\b/
...
/@\S+/
/\$[\w!#$%&'*+\-./:<=>?@\\\\\`|~^]+/
/[-+]?\b(?:\d(?:_?\d)*(?:\.\d(?:_?\d)*)?(?:[Ee][-+]?\d(?:_?\d)*)?|0x[\dA-Fa-f](?:_?[\dA-Fa-f])*(?:\.[\dA-Fa-f](?:_?[\dA-Da-f])*)?(?:[Pp][-+]?\d(?:_?\d)*)?)\b|(?<!\w)inf(?!\w)|(?<!\w)nan(?::0x[\dA-Fa-f](?:_?[\dA-Da-f])*)?\b/
/\(;[^]*?;\)/
/"(?:\\[^]|[^"\\])*"/
...
/[(),.:;[\]{}]/
/\/{2}.*/
/\b(?:break|continue)\s*:\s*\w+(?!\w)|(?<!\w)[A-Z_a-z]\w*\b(?=\s*:\s*(?:\{|while(?!\w)))/
