...
module.exports["Transformers >> all transformers together >> Prism regex snapshot"] = `
/<!--[^]*?-->/
/<\\?[^]+?\\?>/
/<!\\[CDATA\\[[^]*?\\]\\]>/i
/<!DOCTYPE(?:[^"'>[\\]]|"[^"]*"|'[^']*')+(?:\\[(?:[^"'<\\]]|"[^"]*"|'[^']*'|<(?!!--)|<!--(?:[^-]|-(?!->))*-->)*\\]\\s*)?>/i
...
/(?<!\\w)(?:(?:0(?:[Xx](?:[\\dA-Fa-f](?:_[\\dA-Fa-f])?)+|[Bb](?:[01](?:_[01])?)+|[Oo](?:[0-7](?:_[0-7])?)+)n?|(?:\\d(?:_\\d)?)+n|NaN|Infinity)(?!\\w)|(?:(?:\\d(?:_\\d)?)+\\.?(?:\\d(?:_\\d)?)*|\\.(?:\\d(?:_\\d)?)+)(?:[Ee][-+]?(?:\\d(?:_\\d)?)+)?)/
/--|\\+\\+|\\*\\*=?|=>|&&=?|\\|\\|=?|[!=]==|<<=?|>{2,3}=?|[-!%&*+/<=>|^]=?|\\.{3}|\\?\\?=?|\\?\\.?|[:~]/
...
/#.+/
/[-&*+/=\\xf7\\u2260\\u2264\\u2265^]|[<>]=?/
/(?<!\\w)(?:(?:start|begin|end)s? with|does(?: no|n')t contain|contains?|is(?:(?:n'| no)t)?? (?:in|contained by)|(?:is(?:(?:n'| no)t)?? )?(?:greater|less) than(?: or equal)?(?: to)?|(?:does(?: no|n')t come|comes) (?:before|after)|is(?:(?:n'| no)t)?? equal(?: to)?|does(?: no|n')t equal|equals|equal to|isn't|is not|(?:a )?ref(?:(?: to)?|erence to)|and|or|div|mod|as|not)(?!\\w)/
...
/[A-Z_]\\w*(?=\\s*\\()/i
/(?<!\\w)(?:0X(?:[\\dA-F]+\\.?|\\.[\\dA-F])[\\dA-F]*(?:P[-+]?\\d+)?|(?:\\d+\\.?|\\.\\d)\\d*(?:E[-+]?\\d+)?)[FLU]*/i
/>>=?|<<=?|->|&&|\\+\\+|--|::|\\|\\||[:?~]|[-!%&*+/<=>|^]=?/
...
/(?<!\\w)[A-Z_]\\w*(?=\\s*::\\s*~\\w+\\s*\\()/i
/\\w+(?=\\s*<(?:[^<>]|<(?:[^<>]|<[^<>]*>)*>)*>\\s*::\\s*\\w+\\s*\\()/
/(?:(?<!\\w)0B['01]+|(?<!\\w)0X(?:[\\d'A-F]+\\.?|\\.[\\d'A-F])[\\d'A-F]*(?:P[-+]?[\\d']+)?|(?:(?:(?<!\\w)\\d|(?<=\\w)')[\\d']*\\.?|(?<!\\w)\\.[\\d'])[\\d']*(?:E[-+]?[\\d']+)?)[FLU]*/i
/^#/
/##|\\\\(?=[\\n\\r])/
/(?<!\\w)[A-Z_]\\w*(?!\\w)(?!\\s*::)/i
...
/(?<!\\w)(?:0(?:X[\\dA-F_]*[\\dA-F]|B[01_]*[01])|(?:\\.\\d+(?:_+\\d+)*|\\d+(?:_+\\d+)*(?:\\.\\d+(?:_+\\d+)*)?)(?:E[-+]?\\d+(?:_+\\d+)*)?)(?:UL|LU|[DFLMU])?(?!\\w)/i
/>>=?|<<=?|[-=]>|&&|\\+\\+|--|\\|\\||~|\\?\\?=?|[-!%&*+/<=>|^]=?/
/\\?\\.?|::|[(),.:;[\\]{}]/
...
/(?<!\\w)(?:class|enum|interface|struct)\\s+@?[A-Z_a-z]\\w*(?:\\s*<(?:[^-%&*+/;<=>|^]|<(?:[^-%&*+/;<=>|^]|<(?:[^-%&*+/;<=>|^]|<[^-%&*+/;<=>|^]*>)*>)*>)*>|(?!\\w))/
...
/(?:(?<!\\w)|-)\\d+(?!\\w)/
/['(),]/
/(?:^IF|(?<!\\w)(?:NOT|CMDEXTVERSION|DEFINED|ERRORLEVEL|EXIST))(?!\\w)/i
...
/[+>~]|\\|\\|/
/[(),]/
/(?<!\\w)(?:RGB|HSL)(?:\\(\\s*\\d{1,3}\\s*,\\s*\\d{1,3}%?\\s*,\\s*\\d{1,3}%?|A\\(\\s*\\d{1,3}\\s*,\\s*\\d{1,3}%?\\s*,\\s*\\d{1,3}%?\\s*,\\s*(?:0|0?\\.\\d+|1))\\s*\\)(?!\\w)/i
/\\[(?:[^"'[\\]]|"(?:\\\\(?:\\r\\n|[^])|[^\\n\\r"\\\\])*"|'(?:\\\\(?:\\r\\n|[^])|[^\\n\\r'\\\\])*')*\\]/
/[-\\w]+(?=\\()/
/^\\[|\\]\$/
/[\$*|~^]?=/
...
/^\\s*#!.+/
/(?:^|[^\\\\])\\/(?:\\+(?:\\/\\+(?:[^+]|\\+(?!\\/))*\\+\\/|(?!\\/\\+)[^])*?\\+\\/|\\/.*|\\*[^]*?\\*\\/)/
/(?<!\\w)[rx]"(?:\\\\[^]|[^"\\\\])*"[cdw]?|(?<!\\w)q"(?:\\[[^]*?\\]|\\([^]*?\\)|<[^]*?>|\\{[^]*?\\})"|(?<!\\w)q"[A-Z_a-z]\\w*[\\n\\r\\u2028\\u2029](?:[^]*?[\\n\\r\\u2028\\u2029])??[]Unknown:\\\\1[]"|(?<!\\w)q".[^]*?[]Unknown:\\\\2[]"|'(?:\\\\(?:\\W|\\w+)|[^\\\\])'|(?:"(?:\\\\[^]|[^"\\\\])*"|\`(?:\\\\[^]|[^\\\\\`])*\`)[cdw]?/
/(?<!\\w)q\\{(?:\\{[^{}]*\\}|[^{}])*\\}/
...
/(?<!\\w)(?:Som|Non)e(?!\\w)/
/(?<!\\w)(?:Fals|Tru)e(?!\\w)/
/(?:(?<!\\w)NaN|(?:-|(?<!\\w))Infinity|(?:[-+]|(?<!\\w))(?:0x[\\dA-Fa-f]+|\\d+(?:\\.\\d+)?(?:e[-+]?\\d+)?))(?!\\w)/
/\\/\\\\|\\/\\/\\\\\\\\|&&|\\|\\||[!=]=|===|\\/\\/|->|\\+\\+|::|[#*+:<=>?@\\\\|\\u03bb\\u2192\\u2227\\u2261\\u2a53\\u2afd]/
/\\.\\.|[(),./[\\]{}]/
/(?<!\\w)[A-Z]\\w*(?!\\w)/
/"(?:[^"\\\\]|\\\\.)*"|''(?:[^']|'(?!')|'''|''\\\$\\{)*''(?![\$'])/
...
/(?<!\\w)(?:\\d+\\.?|\\.\\d)\\d*(?:E[-+]?\\d+)?/i
/(?:^|[^@])(?:(?<!\\w)|\\?)[A-Z_][\\w@]*/
/[/:<=>]=|=[/:]=|\\+{1,2}|-{1,2}|[!*/=]|(?<!\\w)(?:bnot|div|rem|band|bor|bxor|bsl|bsr|not|and|or|xor|orelse|andalso)(?!\\w)/
/(?:^|[^<])<(?!<)/
/(?:^|[^>])>(?!>)/
/(?<!\\w)(?:\\d+(?:\\.\\d+)?|\\.\\d+)(?:E[-+]?\\d+)?(?!\\w)/i
/(?<!\\w)(?:TRU|FALS)E(?!\\w)/i
...
/(?<!\\w)(?:0b[01_]+(?!\\w)|0x[\\dA-F_a-f]+(?!\\w)|(?:\\d[\\d_]*(?:\\.[\\d_]*)?|\\.[\\d_]+)(?:e[-+]?[\\d_]+)?\\b)/
/(?<!\\w)(?:INF|NAN|PI|TAU)(?!\\w)/
...
/(?<!\\w)(?:this|(?:abstract|as|break|case|cast|catch|class|continue|default|do|dynamic|else|enum|extends|extern|from|for|function|if|implements|import|in|inline|interface|macro|new|null|override|public|private|return|static|super|switch|throw|to|try|typedef|using|var|while)(?!\\.))(?!\\w)/
/\\.{3}|\\+{1,2}|-[->]?|[!=]=?|&{1,2}|\\|{1,2}|<[<=]?|>[=>]?|[%*/~^]/
/"(?:[^"\\\\]|\\\\[^])*"|'(?:[^'\\\\]|\\\\[^])*'/
/~\\/(?:[^\\n\\r/\\\\]|\\\\.)+\\/[gimsu]*/
/#\\w+/
...
/(?<!\\w)(?:TERRAFORM|VAR|SELF|COUNT|MODULE|PATH|DATA|LOCAL)\\.[\\w*]+/i
/(?<!\\w)(?:(?:\\d+\\.?|\\.\\d)\\d*(?:[Ee][-+]?\\d+)?|0x[\\dA-Fa-f]+)[FHLUfhlu]?\\b/
...
/(?<!\\w)(?:bool|double|dword|float|half|int|min1(?:0floa|2in|6(?:floa|in|uin))t|uint)(?:[1-4](?:x[1-4])?)?(?!\\w)/
...
/[(),.:;{}]/
/"[^"]*"/
/^[\\t ]*(?:VOLUME|BOOK|PART(?! OF)|CHAPTER|SECTION|TABLE)[^\\w\\n\\r\\u2028\\u2029].*/im
/(?:^|[^-\\w])(?:\\d+(?:\\.\\d+)?(?:\\^\\d+)?\\w*|ONE|TWO|THREE|FOUR|FIVE|SIX|SEVEN|EIGHT|NINE|TEN|ELEVEN|TWELVE)(?!\\w)(?!-)/i
...
/(?:^|[^-\\w])(?:ABOVE|ADJACENT TO|BACK SIDE OF|BELOW|BETWEEN|DOWN|EAST|EVERYWHERE|FRONT SIDE|HERE|IN|INSIDE(?: FROM)?|NORTH(?:(?:EA|WE)ST)?|NOWHERE|ON(?: TOP OF)?|OTHER SIDE|OUTSIDE(?: FROM)?|PARTS? OF|REGIONALLY IN|SOUTH(?:(?:EA|WE)ST)?|THROUGH|UP|WEST|WITHIN)(?!\\w)(?!-)/i
...
/(?<!\\w)(?:0X[\\dA-F]+(?!\\w)|(?:\\d+\\.?|\\.\\d)\\d*(?:E-?\\d+)?)/i
/[-!%&*+/=|^]=|>{1,2}=?|<{1,2}=?|:?:?=|\\+{1,2}|-{1,2}|\\*{1,2}|\\/{1,2}|%|\\|{1,2}|&{1,2}|(?<!\\w)(?:return|and|or|not)(?!\\w)|@{1,2}|\\?{1,2}|\\.\\./
/"""(?:\\\\[^]|(?!""")[^\\\\])*"""/
/"(?:\\\\.|[^\\n\\r"\\\\])*"/
/(?:^|[^\\\\])#.*/
/(?<!\\w)NB\\..*/
...
/(?<!\\w)(?:0X[\\dA-F]*\\.?[\\dA-F]+|(?:\\d+\\.?|\\.\\d)\\d*(?:E\\d+)?[DFL]?)/i
...
/(?<!\\w)console(?=\\s*\\.)/
/^[A-Z][^]*/
/(?<!\\w)(?:(?:(?:Ui|I)nt(?:8|16|32)|Uint8Clamped|Float(?:32|64))?Array|ArrayBuffer|BigInt|Boolean|DataView|Date|Error|Function|Intl|JSON|Math|Number|Object|Promise|Proxy|Reflect|RegExp|String|Symbol|(?:Weak)?(?:Set|Map)|WebAssembly)(?!\\w)/
/(?<!\\w)[A-Z]\\w*Error(?!\\w)/
...
/@+\\w+/
/(?:[-+]|(?<!\\w))(?:(?:NaN|Infinity|0x[\\dA-Fa-f]+)(?!\\w)|(?:\\d+\\.?|\\.\\d)\\d*(?:[Ee][-+]?\\d+(?!\\w))?)/
/"(?:\\\\(?:\\r\\n?|\\n|.)|[^\\n\\r"\\\\])*"|'(?:\\\\(?:\\r\\n?|\\n|.)|[^\\n\\r'\\\\])*'/
/(?:"(?:\\\\(?:\\r\\n?|\\n|.)|[^\\n\\r"\\\\])*"|'(?:\\\\(?:\\r\\n?|\\n|.)|[^\\n\\r'\\\\])*')(?=\\s*:)/
/[\$A-Z_a-z\\xa0-\\uffff][\\w\$\\xa0-\\uffff]*(?=\\s*:)/
/[\$A-Z_a-z\\xa0-\\uffff][\\w\$\\xa0-\\uffff]*(?=\\s*\\()/
...
/(?:(?<!\\w)html|\\.\\s*(?:inn|out)erHTML\\s*\\+?=)\\s*\`(?:\\\\[^]|\\\$\\{(?:[^{}]|\\{(?:[^{}]|\\{[^}]*\\})*\\})+\\}|(?!\\\$\\{)[^\\\\\`])*\`/
/(?<!\\w)svg\\s*\`(?:\\\\[^]|\\\$\\{(?:[^{}]|\\{(?:[^{}]|\\{[^}]*\\})*\\})+\\}|(?!\\\$\\{)[^\\\\\`])*\`/
/(?<!\\w)m(?:d|arkdown)\\s*\`(?:\\\\[^]|\\\$\\{(?:[^{}]|\\{(?:[^{}]|\\{[^}]*\\})*\\})+\\}|(?!\\\$\\{)[^\\\\\`])*\`/
/(?<!\\w)g(?:ql|raphql(?:\\s*\\.\\s*experimental)?)\\s*\`(?:\\\\[^]|\\\$\\{(?:[^{}]|\\{(?:[^{}]|\\{[^}]*\\})*\\})+\\}|(?!\\\$\\{)[^\\\\\`])*\`/
...
/(?<!\\w)(?:(?=\\d)|(?=\\.))(?:0[BOX])?(?:[\\dA-F]+(?:_[\\dA-F]+)*\\.?(?:\\d+(?:_\\d+)*)?|\\.\\d+(?:_\\d+)*)(?:[EFP][-+]?\\d+(?:_\\d+)*)?J?/i
/&&|\\|\\||[-\$%&*+\\\\\\xf7\\u22bb^]=?|\\/[/=]?|!=?=?|\\|[=>]?|<(?:<=?|[:=|])?|>(?:=|>{1,2}=?)?|={1,2}=?|['~\\u221a\\u221b\\u2260\\u2264\\u2265]/
/:{1,2}|[(),.;?[\\]{}]/
...
/\\+[+=]?|-[-=>]?|={1,2}=?|!(?:!|={1,2})?|[%*/<>]=?|[:?]:?|\\.\\.|&&|\\|\\||(?<!\\w)(?:and|inv|or|shl|shr|ushr|xor)(?!\\w)/
/(?<!\\w)@(?:\\w+:)?(?:[A-Z]\\w*|\\[[^\\]]+\\])/
...
/&[-\\w!\$%*+/<=>@{}~^]+/
/\\([-\\w!\$%*+/<=>@{}~^]+\\s+\\S[^]*(?=\\))/
/(?<!\\w)\\d(?:\\d*~[\\dA-Z]+|[\\d_]*(?:\\.\\d[\\d_]*)?(?:[A-Z]\\w*)?)/i
/[A-Z_](?:-?[A-Z]|[\\d_])*/i
/[(),.:;[\\]\`{|}]/
/(?:^|[^"])"(?:""(?:\\\\[^]|(?!""")[^\\\\])*""|(?:\\\\[^]|[^"\\\\])*)"(?!")/
/\\\\[^\\s),;\\]}]+/
/(?:^|[^-\\w\\n\\r\\u2028\\u2029])(?:break|case|catch|class|const|continue|default|do|else|extends|fallthrough|finally|for(?: ever)?|function|if|implements|it|let|loop|new|null|otherwise|own|return|super|switch|that|then|this|throw|try|unless|until|var|void|when|while|yield)(?!-)(?!\\w)/m
/(?:^|[^-\\w])(?:(?:delete|require|typeof)!|(?:and|by|delete|export|from|import(?: all)?|in|instanceof|is(?:(?:n| no)t)?|not|of|or|til|to|typeof|with|xor)(?!-)(?!\\w))/m
...
/(?:^|[^\\\\])#[_a-z](?:-?[a-z]|[\\d_])*/m
/(?:^|[^\\\\])#\\{[^}]+\\}/m
/[!#%@](?:(?:[\$\\-.A-Z_]|\\\\[\\dA-F]{2})(?:[\\w\$\\-.]|\\\\[\\dA-F]{2})*|\\d+)/i
/(?:[\$\\-.A-Z_]|\\\\[\\dA-F]{2})(?:[\\w\$\\-.]|\\\\[\\dA-F]{2})*:/i
/(?<!\\w)[_a-z][\\d_a-z]*(?!\\w)/
/(?:(?:[-+]|(?<!\\w))\\d+(?:\\.\\d+)?(?:[Ee][-+]?\\d+)?|(?<!\\w)0x[\\dA-Fa-f]+|(?<!\\w)0xK[\\dA-Fa-f]{20}|(?<!\\w)0x[LM][\\dA-Fa-f]{32}|(?<!\\w)0xH[\\dA-Fa-f]{4})(?!\\w)/
/[!()*,.;<=>[\\]{}]/
...
/(?:^|[^\\\\])#(?:\\\\(?:\\r\\n|[^])|[^\\n\\r\\\\])*/
/^[^\\n\\r:=]+(?=\\s*:(?!=))/m
/(?:-include|(?<!\\w)(?:define|else|endef|endif|export|ifn?def|ifn?eq|include|override|private|sinclude|undefine|unexport|vpath))(?!\\w)/
/\\\$+(?:[^\\s#():={}]+|(?=[({]))/
/\\((?:addsuffix|abspath|and|basename|call|dir|error|eval|file|filter(?:-out)?|findstring|firstword|flavor|foreach|guile|if|info|join|lastword|load|notdir|or|origin|patsubst|realpath|shell|sort|strip|subst|suffix|value|warning|wildcard|word(?:s|list)?)(?=[\\t ])/
/(?<!\\w)(?:(?:\\d+\\.?|\\.\\d)\\d*(?:[Ee][-+]?\\d+)?[ij]?|[ij](?!\\w))/
...
/@{1,2}\\w*/
/(?<!\\w)(?:(?:\\.\\d+|\\d+\\.\\d+|\\d+(?=[Ee]))(?:[Ee][-+]?\\d+)?|(?:0x[\\dA-Fa-f]+|\\d+)(?:U?LL)?)(?!\\w)/
...
/[-%*+/=]|!=|={1,2}|\\|\\||<[=>]?|>=?|(?<!\\w)(?:AND|ANY|ARRAY|BETWEEN|CASE|ELSE|END|EVERY|EXISTS|FIRST|IN|LIKE|NOT|OR|THEN|VALUED|WHEN|WITHIN)(?!\\w)/i
/[(),.:;[\\]{}]/
/"(?:\\\\[^]|[^"\\\\]|"")*"|'(?:\\\\[^]|[^'\\\\]|'')*'/
/\`(?:\\\\[^]|[^\\\\\`]|\`\`)*\`/
...
/(?<!\\w)[A-Z][\\dA-Za-z]*|\`(?:[^\\\\\`]|\\\\.)+\`/
/:(?:=|:{1,2})|<[-:=]?|=(?:=|<?:?)|>=?:?|\\\\=:?|!{1,2}|[-#*+,/@|~^]|(?<!\\w)(?:andthen|div|mod|orelse)(?!\\w)/
/[().:;?[\\]{}]/
/"(?:[^"\\\\]|\\\\[^])*"/
/'(?:[^'\\\\]|\\\\[^])*'/
/(?<!\\w)[a-z][\\dA-Za-z]*(?=\\()/
...
/\\s#.*/
/(?:^|[^\\^])\\((?:[^()]|\\((?:[^()]|\\([^()]*\\))*\\))*\\)/
/(?:^|[^\\^])(?:\\^(?:case|eval|for|if|switch|throw)|@(?:BASE|CLASS|GET(?:_DEFAULT)?|OPTIONS|SET_DEFAULT|USE))(?!\\w)/
/(?:^|[^\\w^])\\\$(?:\\w+|(?=[.{]))(?:(?:\\.|:{1,2})\\w+)*(?:\\.|:{1,2})?/
/(?:^|[^\\w^])[@^]\\w+(?:(?:\\.|:{1,2})\\w+)*(?:\\.|:{1,2})?/
/\\^(?:["\$'():;@[\\]\\^{}]|#[\\dA-F]*)/i
/(?<!\\w)(?:0X[\\dA-F]+|\\d+\\.?\\d*(?:E[-+]?\\d+)?)\\b/i
/[%*+/\\\\~]|!(?:\\|{1,2}|=)?|&{1,2}|\\|{1,2}|==|<[<=]?|>[=>]?|-[df]?|(?<!\\w)(?:def|eq|ge|gt|in|is|le|lt|ne)(?!\\w)/
/\\.|:+/
/(?:^|[^\\^])(?:"(?:[^"^]|\\^[^])*"|'(?:[^'^]|\\^[^])*')/
/^@[GS]ET_/
/\\(\\.|\\.\\)|[(),.:;[\\]]/
...
/-[ABCMORSTWXb-gklopr-uwxz](?!\\w)|\\+[+=]?|-[-=>]?|\\*{1,2}=?|\\/{1,2}=?|=[=>~]?|~[=~]?|\\|{1,2}=?|&{1,2}=?|<(?:=>?|<=?)?|>{1,2}=?|![=~]?|[%^]=?|\\.(?:=|\\.{1,2})?|[?\\\\]|(?<!\\w)x(?:=|(?!\\w))|(?<!\\w)(?:lt|gt|le|ge|eq|ne|cmp|not|and|or|xor)(?!\\w)/
/[\$%&*@]\\{\\^[A-Z]+\\}/
/[\$%&*@]\\^[A-Z_]/
/[\$%&*@]#?(?=\\{)/
/[\$%&*@]#?(?:(?:::)*'?[\$A-Z_][\\w\$]*)+(?:::)*/i
...
/(?<!\\w)JoinSide\\.(?:Lef|Righ)t(?!\\w)/
/(?<!\\w)Precision\\.D(?:ouble|ecimal)(?!\\w)/
...
/^[\\t ]*(?:block|extends|include|append|prepend)[^\\w\\n\\r\\u2028\\u2029].*/m
/^[\\t ]*script(?:(?:&[^(]+)?\\([^)]+\\))*[\\t ]+.+/m
/^[\\t ]*(?:[\\w#.][\\w#\\-.]*[-\\w]|\\w)(?:(?:&[^(]+)?\\([^)]+\\))*\\/?[\\t ]+.+/m
/^[\\t ]*(?:[\\w#.][\\w#\\-.]*[-\\w]|\\w)(?:(?:&[^(]+)?\\([^)]+\\))*\\/?:?/m
/^[\\t ]*mixin .+/m
...
/^\\s*!.*/m
/(?<!\\w)(?:ST\\d|[XYZ]MM\\d{1,2}|[CDT]R\\d|R\\d{1,2}[BDW]?|[ER]?[A-D]X|[A-D][HL]|[ER]?(?:BP|SP|SI|DI)|[C-GS]S|MM\\d+)(?!\\w)/i
/(?:(?<!\\w)(?=\\w)|(?<=\\w)(?!\\w)|-|(?=\\\$))(?:0[HX][\\dA-F]*\\.?[\\dA-F]+(?:P[-+]?\\d+)?|\\d[\\dA-F]+[HX]|\\\$\\d[\\dA-F]*|0[OQ][0-7]+|[0-7]+[OQ]|0[BY][01]+|[01]+[BY]|0[DT]\\d+|\\d*\\.?\\d+(?:\\.?E[-+]?\\d+)?[DT]?)(?!\\w)/i
/[!\$%&*+,\\-./:<=>[\\]|]/
/\\s*!\\s*J[A-Z]+\\s+@[BF]/i
...
/:[\\t ]*(?![\\s;[}])(?!\$|[;}])(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\}|\\\\[^])*\\)|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\}|\\\\[^])*\\}|\\\\[^])(?:(?!\$|[;}])(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\((?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\)|\\[(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\]|\\{(?:[^"'()/[\\\\\\]{}]|"(?:\\\\.|[^\\n\\r"\\\\])*"|'(?:\\\\.|[^\\n\\r'\\\\])*'|\\/(?![*/])|\\/\\/.*\$|\\/\\*(?:[^*]|\\*(?!\\/))*\\*\\/|\\(\\)|\\[\\]|\\{\\}|\\\\[^])*\\}|\\\\[^])*\\}|\\\\[^])*\\}|\\\\[^]))*/m
/(?:^|[;{])[\\t ]*[A-Z_]\\w*(?:\\.\\w+)*(?=[\\t ]*:)/im
/(?:^|[;{])[\\t ]*property[\\t ]+[A-Z_a-z]\\w*(?:\\.\\w+)*[\\t ]+[A-Z_a-z]\\w*(?:\\.\\w+)*(?=[\\t ]*:)/m
/^property/
/\\w+(?:\\.\\w+)*/
...
/%[^\\s%]*%/
/(?<!\\w)(?:NaN|Inf)(?!\\w)/
/(?<!\\w)(?:0x[\\dA-Fa-f]+(?:\\.\\d*)?|\\d+\\.?\\d*|\\.\\d+)(?:[EPep][-+]?\\d+)?[Li]?/
/['()[\\]]/
/^#lang.+/m
/'[^\\s#'()[\\]]+/
/[([]lambda\\s+[([][^\\s'()[\\]]+/
...
/\\.{3}|:[:=]|\\|>|->|=(?:={1,2}|>)?|<=?|>=?|[!#'?\`|~^]|[-*+/]\\.?|(?<!\\w)(?:mod|land|lor|lxor|lsl|lsr|asr)(?!\\w)/
...
/(?<!\\w)(?:crate|self|super)\\s*::\\s*[a-z][\\d_a-z]*(?:\\s*::(?:\\s*[a-z][\\d_a-z]*\\s*::)*|(?!\\w))/
...
/=>|->|:=|=:|\\*\\*|\\+\\+|--|\\|\\||&&|<<=?|>>=?|[-!%&*+/<=>|^]=?|[?~]/
/(?<!\\w)(?:contract|enum|interface|library|new|struct|using)\\s+[\$A-Z_a-z][\\w\$]*/
/(?:[<>]=?|\\^)\\d+\\.\\d+\\.\\d+(?!\\w)/
/(?<!\\w)(?:FALS|TRU)E(?!\\w)/
/^[\\t ]*(?:[A-Z]\\w*(?!\\w)(?=.*(?:\\r\\n?|\\n)(?:[]Unknown:\\\\1[][\\t ].*(?:\\r\\n?|\\n))*[]Unknown:\\\\1[]End[]Unknown:\\\\2[][\\t ]*\$)|End[A-Z]\\w*(?=[\\t ]*\$))/m
/^[\\t ]*[^\\n\\r"#()=]*[^\\s"#()=](?=\\s*=)/m
/\\{[\\dA-F]{8}-[\\dA-F]{4}-[\\dA-F]{4}-[\\dA-F]{4}-[\\dA-F]{12}\\}/i
/(?<!\\w)(?:\\d+(?:\\.\\d+)?(?:[Ee][-+]?\\d+)?|0x[\\dA-F]+)(?!\\w)/
/\\?:?|<=?|>=?|={1,2}|!=|[-%*+/]|(?<!\\w)(?:and|not|or)(?!\\w)/
/[(),.:[\\]{|}]/
...
/"""(?:"{0,2}(?:[^"\\\\]|\\\\.))*"""|'''(?:'{0,2}(?:[^'\\\\]|\\\\.))*'''/
/"(?:[^\\n\\r"\\\\]|\\\\.)*"|'(?:[^\\n\\r'\\\\]|\\\\.)*'/
/<(?:[^\\0-\\x20"<>\\\\\`{|}^]|\\\\(?:u|U[\\dA-Fa-f]{4})[\\dA-Fa-f]{4})*>/
/(?:[A-Z_\\xb5\\xc0-\\ufffd][\\w\\-.\\xb5\\xb7\\xc0-\\ufffd]*)?:(?:(?:[\\w:\\xb5\\xc0-\\ufffd]|%[\\dA-F]{2}|\\\\.)(?:[\\w\\-.:\\xb5\\xc0-\\ufffd]|%[\\dA-F]{2}|\\\\.)*)?/i
/(?:(?<!\\w)a|@prefix|@base)(?!\\w)|=/
...
/(?<!\\w)(?:AT|BOOL|BYTE|[DL]?WORD|U?[DLS]?INT|L?REAL|TIME(?:_OF_DAY)?|TOD|DT|DATE(?:_AND_TIME)?|STRING|ARRAY|ANY|POINTER)(?!\\w)/
/%(?:[IMQ][BDLWX]|[IQ])[\\d.]*/
/(?<!\\w)(?:16#[\\dA-F]+|2#[01_]+|0X[\\dA-F]+)(?!\\w)|(?<!\\w)(?:[DT]|DT|TOD)#[\\d:DHMS_]*|\\b[A-Z]*#[\\d,._]*|(?<!\\w)(?:\\d+\\.?|\\.\\d)\\d*(?:E[-+]?\\d+)?/i
/(?<!\\w)(?:TRUE|FALSE|NULL)(?!\\w)/
...
/\\\$[A-Z]\\w*(?:\\.(?:\\d+|\\\$?[A-Z]\\w*))*/i
/(?:(?<!\\w)0(?:x[\\dA-Za-z]+(?:_[\\dA-Za-z]+)*|o[0-7]+(?:_[0-7]+)*|b[01]+(?:_[01]+)*)|(?:[-+]|(?<!\\w))\\d+(?:_\\d+)*(?:\\.\\d+(?:_\\d+)*)?(?:[Ee][-+]?\\d+(?:_\\d+)*)?|(?:[-+]|(?<!\\w))(?:inf|nan))(?!\\w)/
/[,.=[\\]{}]/
/^\\s*\\[\\s*(?:\\[\\s*)?(?:[-\\w]+|'[^\\n\\r']*'|"(?:\\\\.|[^\\n\\r"\\\\])*")(?:\\s*\\.\\s*(?:[-\\w]+|'[^\\n\\r']*'|"(?:\\\\.|[^\\n\\r"\\\\])*"))*(?=\\s*\\])/m
/(?:^|[,{])\\s*(?:[-\\w]+|'[^\\n\\r']*'|"(?:\\\\.|[^\\n\\r"\\\\])*")(?:\\s*\\.\\s*(?:[-\\w]+|'[^\\n\\r']*'|"(?:\\\\.|[^\\n\\r"\\\\])*"))*(?=\\s*=)/m
/"""(?:\\\\[^]|[^\\\\])*?"""|'''[^]*?'''|'[^\\n\\r']*'|"(?:\\\\.|[^\\n\\r"\\\\])*"/
...
/>>|<<|--|\\+\\+|\\*\\*|[-!\$*+/<=>@~]=?|&{1,2}|\\|{1,2}|\\^{1,2}|[%:?]|(?<!\\w)(?:Cross|Dot|ClockwiseFrom)(?!\\w)/
/[(),.;[\\]{}]/
...
/(?<!\\w)always(?:_(?:latch|comb|ff))?(?: |(?!\\w))@?/
/(?<!\\w)#{1,2}\\d+|(?:(?<!\\w)\\d+)?'[BDHO] ?[\\d?A-FXZ_]+|\\b\\d*[._]?\\d+(?:E[-+]?\\d+)?/i
/[-!%&*+/<=>?{|}~^]+/
/[(),.:;[\\]]/
/"(?:\\\\(?:\\r\\n|[^])|[^\\n\\r"\\\\])*"/
/"(?:[^\\n\\r"\\\\]|\\\\(?:\\r\\n|[^]))*"/
...
/\\\$?["\\u201c\\u201d](?:["\\u201c\\u201d]{2}|[^"\\u201c\\u201d])*["\\u201c\\u201d]C?/i
/#[\\t\\x0b\\f \\xa0\\u1680\\u2000-\\u200a\\u2028\\u2029\\u202f\\u205f\\u3000\\ufeff]*\\d+(?:(?:-\\d+-|\\/\\d+\\/)\\d+(?:[\\t\\x0b\\f \\xa0\\u1680\\u2000-\\u200a\\u2028\\u2029\\u202f\\u205f\\u3000\\ufeff]+\\d+(?:[\\t\\x0b\\f \\xa0\\u1680\\u2000-\\u200a\\u2028\\u2029\\u202f\\u205f\\u3000\\ufeff]*[AP]M|:\\d+(?::\\d+)?(?:[\\t\\x0b\\f \\xa0\\u1680\\u2000-\\u200a\\u2028\\u2029\\u202f\\u205f\\u3000\\ufeff]*[AP]M)?))?|[\\t\\x0b\\f \\xa0\\u1680\\u2000-\\u200a\\u2028\\u2029\\u202f\\u205f\\u3000\\ufeff]*[AP]M|:\\d+(?::\\d+)?(?:[\\t\\x0b\\f \\xa0\\u1680\\u2000-\\u200a\\u2028\\u2029\\u202f\\u205f\\u3000\\ufeff]*[AP]M)?)[\\t\\x0b\\f \\xa0\\u1680\\u2000-\\u200a\\u2028\\u2029\\u202f\\u205f\\u3000\\ufeff]*#/i
/[-!#\$%&*+/<=>@\\\\^]/
...
/(?<!\\w)(?:false|true|F|T)(?!\\w)/
/<%|%>|[()[\\]{}]/
/==|&{1,2}|\\|{1,2}|\\*{1,2}|>{2,3}|<<|==|[!<>~]=?|[-%/^]|\\+!?|(?<!\\w)(?:AND|NOT|OR)(?!\\w)/
/"(?:[^\\n\\r"\\\\]|\\\\.)*"|'(?:[^\\n\\r'\\\\]|\\\\.)*'|<'(?:[^'\\\\]|'(?!>)|\\\\.)*'>/
/@\\S+/
/\\\$[\\w!#\$%&'*+\\-./:<=>?@\\\\\`|~^]+/
/(?:(?:[-+]|(?<!\\w))(?:\\d(?:_?\\d)*(?:\\.\\d(?:_?\\d)*)?(?:[Ee][-+]?\\d(?:_?\\d)*)?|0x[\\dA-Fa-f](?:_?[\\dA-Fa-f])*(?:\\.[\\dA-Fa-f](?:_?[\\dA-Da-f])*)?(?:[Pp][-+]?\\d(?:_?\\d)*)?)|(?<!\\w)inf|(?<!\\w)nan(?::0x[\\dA-Fa-f](?:_?[\\dA-Da-f])*)?)(?!\\w)/
/\\(;[^]*?;\\)/
/"(?:\\\\[^]|[^"\\\\])*"/
...
/[(),.:;[\\]{}]/
/\\/{2}.*/
/(?<!\\w)(?:(?:break|continue)\\s*:\\s*\\w+(?!\\w)|[A-Z_a-z]\\w*(?=\\s*:\\s*(?:\\{|while(?!\\w))))/
/(?<!\\w)[A-Z_a-z]\\w*(?=\\s*=\\s*(?:(?:extern|packed)\\s+)?(?:enum|struct|union)\\s*[({])/
/(?<!\\w)(?:anyerror|bool|c_u?(?:short|int|long|longlong)|c_longdouble|c_void|comptime_(?:floa|in)t|[iu](?:8|16|32|64|128|size)|f(?:16|32|64|128)|noreturn|type|void)(?!\\w)/
/\\/{3}.*/
/(?:^|[^@\\\\])c?"(?:[^\\n\\r"\\\\]|\\\\.)*"/
/[\\n\\r][\\t ]+c?\\\\{2}.*(?:(?:\\r\\n?|\\n)[]Unknown:\\\\2[].*)*/
/(?:^|[^\\\\])'(?:[^\\n\\r'\\\\]|\\\\(?:.|x[\\dA-Fa-f]{2}|u\\{[\\dA-Fa-f]{1,6}\\}))'/
/:\\s*(?:!|(?!\\s))\\s*(?:(?:(?:\\?|(?<!\\w)promise->|(?:\\[[^[\\]]*\\]|\\*(?!\\*)|\\*\\*)(?:\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)|const(?!\\w)|volatile(?!\\w)|allowzero(?!\\w)))*)\\s*)*(?:\\?|(?<!\\w)promise->|(?:\\[[^[\\]]*\\]|\\*|\\*\\*)(?:\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)|const(?!\\w)|volatile(?!\\w)|allowzero(?!\\w)))*)(?:\\s+|(?<!\\w)))?(?:promise(?!\\w)|(?:error\\.)?(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?:(?:\\.(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?!\\w))+|(?!\\w))(?!\\s+(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?!\\w)))(?:!?\\s*(?:(?:(?:(?:\\?|(?<!\\w)promise->|(?:\\[[^[\\]]*\\]|\\*(?!\\*)|\\*\\*)(?:\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)|const(?!\\w)|volatile(?!\\w)|allowzero(?!\\w)))*)\\s*)*(?:\\?|(?<!\\w)promise->|(?:\\[[^[\\]]*\\]|\\*|\\*\\*)(?:\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)|const(?!\\w)|volatile(?!\\w)|allowzero(?!\\w)))*)\\s*){1}(?<!\\w)|(?<!\\w))(?:promise(?!\\w)|(?:error\\.)?(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?:(?:\\.(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?!\\w))+|(?!\\w))(?!\\s+(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?!\\w))))*(?=\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)\\s*)?[),;=])|(?:!|(?!\\s))\\s*(?:(?:(?:(?:\\?|(?<!\\w)promise->|(?:\\[[^[\\]]*\\]|\\*(?!\\*)|\\*\\*)(?:\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)|const(?!\\w)|volatile(?!\\w)|allowzero(?!\\w)))*)\\s*)*(?:\\?|(?<!\\w)promise->|(?:\\[[^[\\]]*\\]|\\*|\\*\\*)(?:\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)|const(?!\\w)|volatile(?!\\w)|allowzero(?!\\w)))*)\\s*){1}(?<!\\w)|(?<!\\w))(?:promise(?!\\w)|(?:error\\.)?(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?:(?:\\.(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?!\\w))+|(?!\\w))(?!\\s+(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?!\\w)))(?:!?\\s*(?:(?:(?:(?:\\?|(?<!\\w)promise->|(?:\\[[^[\\]]*\\]|\\*(?!\\*)|\\*\\*)(?:\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)|const(?!\\w)|volatile(?!\\w)|allowzero(?!\\w)))*)\\s*)*(?:\\?|(?<!\\w)promise->|(?:\\[[^[\\]]*\\]|\\*|\\*\\*)(?:\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)|const(?!\\w)|volatile(?!\\w)|allowzero(?!\\w)))*)\\s*){1}(?<!\\w)|(?<!\\w))(?:promise(?!\\w)|(?:error\\.)?(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?:(?:\\.(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?!\\w))+|(?!\\w))(?!\\s+(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?!\\w))))*(?=\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)\\s*)?\\{)/
/\\)\\s*(?:!|(?!\\s))\\s*(?:(?:(?:\\?|(?<!\\w)promise->|(?:\\[[^[\\]]*\\]|\\*(?!\\*)|\\*\\*)(?:\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)|const(?!\\w)|volatile(?!\\w)|allowzero(?!\\w)))*)\\s*)*(?:\\?|(?<!\\w)promise->|(?:\\[[^[\\]]*\\]|\\*|\\*\\*)(?:\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)|const(?!\\w)|volatile(?!\\w)|allowzero(?!\\w)))*)(?:\\s+|(?<!\\w)))?(?:promise(?!\\w)|(?:error\\.)?(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?:(?:\\.(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?!\\w))+|(?!\\w))(?!\\s+(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?!\\w)))(?:!?\\s*(?:(?:(?:(?:\\?|(?<!\\w)promise->|(?:\\[[^[\\]]*\\]|\\*(?!\\*)|\\*\\*)(?:\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)|const(?!\\w)|volatile(?!\\w)|allowzero(?!\\w)))*)\\s*)*(?:\\?|(?<!\\w)promise->|(?:\\[[^[\\]]*\\]|\\*|\\*\\*)(?:\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)|const(?!\\w)|volatile(?!\\w)|allowzero(?!\\w)))*)\\s*){1}(?<!\\w)|(?<!\\w))(?:promise(?!\\w)|(?:error\\.)?(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?:(?:\\.(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?!\\w))+|(?!\\w))(?!\\s+(?!(?<!\\w)(?:align|allowzero|and|asm|async|await|break|cancel|catch|comptime|const|continue|defer|else|enum|errdefer|error|export|extern|fn|for|if|inline|linksection|nakedcc|noalias|null|or|orelse|packed|promise|pub|resume|return|stdcallcc|struct|suspend|switch|test|threadlocal|try|undefined|union|unreachable|usingnamespace|var|volatile|while)(?!\\w))[A-Z_a-z]\\w*(?!\\w))))*(?=\\s*(?:align\\s*\\((?:[^()]|\\([^()]*\\))*\\)\\s*)?;)/
`.slice(1, -1);
