...
module.exports[n`Transformers >> factor-out >> /a(?:b|c)|b|c|d/ `] = lit`
/a?(?:b|c)|d/
`;

module.exports[n`Transformers >> factor-out >> /b|c|a(?:b|c)|d/ `] = lit`
/a??(?:b|c)|d/
`;
