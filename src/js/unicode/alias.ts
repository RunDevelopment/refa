...
export const NonBinaryProperty: Record<string, "General_Category" | "Script" | "Script_Extensions"> = {
...
export const ScriptAndScript_Extensions = {
	"Adlam": "Adlam",
	"Adlm": "Adlam",
	"Ahom": "Ahom",
